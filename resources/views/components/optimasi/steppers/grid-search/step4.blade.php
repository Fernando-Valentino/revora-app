                    ...
                    <div>
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <select id="rayon_id_gs" name="rayon_id" class="form-select form-select-sm optimasi-rayon-filter" style="font-size: 12px; padding: 4px 12px; height: 32px; width: auto; min-width: 140px;">
                                    <option value="0">Semua Rayon</option>
                                    @foreach($rayons as $rayon)
