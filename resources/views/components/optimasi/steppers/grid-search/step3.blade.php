...
<div id="grid-step-content-3" class="step-opt-content d-none">
    ...
    <!-- Detail Preprocessing tabs inside Grid Step 3 -->
        ...
        <div class="card-body">
            ...
            @else
                ...
                <div class="d-flex align-items-start flex-column flex-md-row gap-3">
                    <!-- Tabs List -->
                    <div class="nav flex-column nav-pills me-2 col-12 col-md-4 col-lg-3" id="grid-v-pills-tab" role="tablist" aria-orientation="vertical">
                        <button class="nav-link active" id="grid-grid-v-pills-cleaning-tab" data-bs-toggle="pill" data-bs-target="#grid-v-pills-cleaning" type="button" role="tab" aria-controls="grid-v-pills-cleaning" aria-selected="true"><span class="tab-step-number">1</span> 1. Pembersihan Data</button>
                        <button class="nav-link" id="grid-grid-v-pills-fe-tab" data-bs-toggle="pill" data-bs-target="#grid-v-pills-fe" type="button" role="tab" aria-controls="grid-v-pills-fe" aria-selected="false"><span class="tab-step-number">2</span> 2. Rekayasa Fitur</button>
                        <button class="nav-link" id="grid-grid-v-pills-target-tab" data-bs-toggle="pill" data-bs-target="#grid-v-pills-target" type="button" role="tab" aria-controls="grid-v-pills-target" aria-selected="false"><span class="tab-step-number">3</span> 3. Transformasi Data</button>
                        <button class="nav-link" id="grid-grid-v-pills-normalisasi-tab" data-bs-toggle="pill" data-bs-target="#grid-v-pills-normalisasi" type="button" role="tab" aria-controls="grid-v-pills-normalisasi" aria-selected="false"><span class="tab-step-number">4</span> 4. Normalisasi Data</button>
                        <button class="nav-link" id="grid-grid-v-pills-split-tab" data-bs-toggle="pill" data-bs-target="#grid-v-pills-split" type="button" role="tab" aria-controls="grid-v-pills-split" aria-selected="false"><span class="tab-step-number">5</span> 5. Pembagian Data (Split)</button>
                        <button class="nav-link" id="grid-grid-v-pills-training-tab" data-bs-toggle="pill" data-bs-target="#grid-v-pills-training" type="button" role="tab" aria-controls="grid-v-pills-training" aria-selected="false"><span class="tab-step-number">6</span> 6. Pelatihan Model SVR</button>
                        <button class="nav-link" id="grid-grid-v-pills-prediction-tab" data-bs-toggle="pill" data-bs-target="#grid-v-pills-prediction" type="button" role="tab" aria-controls="grid-v-pills-prediction" aria-selected="false"><span class="tab-step-number">7</span> 7. Prediksi Pendapatan</button>
                    </div>

                    <!-- Tabs Content -->
                    <div class="tab-content flex-grow-1 col-12 col-md-8 col-lg-9 border p-4 rounded-3" id="grid-grid-v-pills-tabContent" style="background-color: #ffffff;">
                        @php
                            $rayonRomanMap = [1 => 'I', 2 => 'II', 3 => 'III', 4 => 'IV', 5 => 'V'];
                        @endphp
                        <!-- Tab 1: Pembersihan Data -->
                        <div class="tab-pane fade show active" id="grid-v-pills-cleaning" role="tabpanel" aria-labelledby="grid-grid-v-pills-cleaning-tab">
                            ...
                            @if($pipelineData && isset($pipelineData['raw_snapshot']) && isset($pipelineData['cleaned_snapshot']))
                                <div class="card border border-light shadow-sm">
                                    <div class="card-header bg-light py-1.5 px-3">
                                        <ul class="nav nav-tabs card-header-tabs border-bottom-0" id="grid-cleaning-snapshot-tabs" role="tablist">
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link active fw-bold text-xs py-1.5 px-3 border-0 bg-transparent text-secondary" id="grid-raw-snapshot-tab" data-bs-toggle="tab" data-bs-target="#grid-raw-snapshot-pane" type="button" role="tab" aria-controls="grid-raw-snapshot-pane" aria-selected="true" style="transition: all 0.2s;">
                                                    <i class="bi bi-file-earmark-spreadsheet me-1"></i>1. Sebelum Pembersihan (Raw Data)
                                                </button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button class="nav-link fw-bold text-xs py-1.5 px-3 border-0 bg-transparent text-secondary" id="grid-cleaned-snapshot-tab" data-bs-toggle="tab" data-bs-target="#grid-cleaned-snapshot-pane" type="button" role="tab" aria-controls="grid-cleaned-snapshot-pane" aria-selected="false" style="transition: all 0.2s;">
                                    ...
                                    <div class="tab-content" id="grid-grid-cleaning-snapshot-tabsContent">
                                        ...
                                        <div class="tab-pane fade show active" id="grid-raw-snapshot-pane" role="tabpanel" aria-labelledby="grid-raw-snapshot-tab">
                                        ...
                                        <div class="tab-pane fade" id="grid-cleaned-snapshot-pane" role="tabpanel" aria-labelledby="grid-cleaned-snapshot-tab">
                                            <div class="table-responsive">
                                                <table class="table table-sm align-middle mb-0 table-hover table-preview-custom">
                                                    <thead class="table-light">
                                                        <tr class="text-secondary text-xs">
                        ...
                        <div class="tab-pane fade" id="grid-v-pills-fe" role="tabpanel" aria-labelledby="grid-grid-v-pills-fe-tab">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="tab-pane fade" id="grid-v-pills-target" role="tabpanel" aria-labelledby="grid-grid-v-pills-target-tab">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="tab-pane fade" id="grid-v-pills-normalisasi" role="tabpanel" aria-labelledby="grid-grid-v-pills-normalisasi-tab">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="tab-pane fade" id="grid-v-pills-split" role="tabpanel" aria-labelledby="grid-grid-v-pills-split-tab">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="tab-pane fade" id="grid-v-pills-training" role="tabpanel" aria-labelledby="grid-grid-v-pills-training-tab">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <div class="tab-pane fade" id="grid-v-pills-prediction" role="tabpanel" aria-labelledby="grid-grid-v-pills-prediction-tab">
                            <div class="d-flex justify-content-between align-items-center mb-3">
