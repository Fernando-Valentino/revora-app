        ...
        @else
                ...
                <div id="method-content-grid" class="method-section">
                    ...
                    <div class="card mb-4 bg-white shadow-sm border border-light">
                        <div class="card-body py-3">
                            <div class="stepper-wrapper">
                                <div class="stepper-item active" id="stepper-grid-1" onclick="goToGridStep(1)"
                    ...
                    <div id="grid-step-content-1" class="step-opt-content">
                        ...
                        <div class="row g-4 mb-4">
                            ...
                            <div class="col-md-6">
                                <div class="card h-100 mb-0 shadow-sm border border-light bg-white">
                                    <div class="card-body">
                                        <h5 class="card-title text-dark"><i
                                                class="bi bi-info-circle-fill me-2 text-primary-custom"></i>Ringkasan Dataset</h5>
                                        <div class="table-responsive">
                                            <table class="table table-borderless align-middle mb-0 text-sm">
                                                <tbody>
                                                    <tr>
                                                        <td class="fw-semibold text-secondary" style="width: 50%;">Total Data
                                                            Pendapatan</td>
                                                        <td class="text-end fw-bold text-dark">
                                                            {{ number_format($totalPendapatan, 0, ',', '.') }} Baris</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            <span
                                                                class="badge bg-primary-subtle text-primary border-0 me-1">{{ $jumlahHariLibur }}
                                                                Libur</span>
                                                            <span
                                                                class="badge bg-warning-subtle text-warning border-0">{{ $jumlahWeekend }}
                                                                Weekend</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-end">
                                                            @if($datasetReady)
                                                                <span class="badge bg-success-subtle text-success border-0"><i
                                                                        class="bi bi-patch-check-fill me-1"></i>Siap Diproses</span>
                                                            @else
                                                                <span class="badge bg-danger-subtle text-danger border-0"><i
                                                                        class="bi bi-exclamation-triangle-fill me-1"></i>Belum
                                                                    Siap</span>
                                                            @endif
                                                        </td>
                                                    </tr>
                            ...
                            <div class="col-md-6">
                                <div class="card h-100 mb-0 shadow-sm border border-light bg-white">
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        <div>
                                            <h5 class="card-title text-dark"><i
                                                    class="bi bi-shield-check-fill me-2 text-primary-custom"></i>Validasi
                                                Kelengkapan Dataset</h5>
                                            <ul class="list-group list-group-flush text-sm">
                                                <li
                                                    class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-light py-2 px-0">
                                                    <span><i
                                                            class="bi {{ $hasPendapatan ? 'bi-check-circle-fill text-success' : 'bi-x-circle-fill text-danger' }} me-2"></i>
                                                        Data pendapatan</span>
                                                    <span
                                                        class="badge {{ $hasPendapatan ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger' }} border-0">{{ $hasPendapatan ? 'Lengkap' : 'Tidak Ada' }}</span>
                                                </li>
                                                <li
                                                    class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-light py-2 px-0">
                                                    <span><i
                                                            class="bi {{ $hasRayon ? 'bi-check-circle-fill text-success' : 'bi-x-circle-fill text-danger' }} me-2"></i>
                                                        Data rayon</span>
                                                    <span
                                                        class="badge {{ $hasRayon ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger' }} border-0">{{ $hasRayon ? 'Lengkap' : 'Tidak Ada' }}</span>
                                                </li>
                                                <li
                                                    class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-light py-2 px-0">
                                                    <span><i
                                                            class="bi {{ $hasJuruParkir ? 'bi-check-circle-fill text-success' : 'bi-x-circle-fill text-danger' }} me-2"></i>
                                                        Data juru parkir</span>
                                                    <span
                                                        class="badge {{ $hasJuruParkir ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger' }} border-0">{{ $hasJuruParkir ? 'Lengkap' : 'Tidak Ada' }}</span>
                                                </li>
                                                <li
                                                    class="list-group-item d-flex justify-content-between align-items-center bg-transparent border-light py-2 px-0">
                                                    <span><i
                                                            class="bi {{ $hasHariLibur ? 'bi-check-circle-fill text-success' : 'bi-x-circle-fill text-danger' }} me-2"></i>
                                                        Data hari libur dan weekend</span>
                                                    <span
                                                        class="badge {{ $hasHariLibur ? 'bg-success-subtle text-success' : 'bg-danger-subtle text-danger' }} border-0">{{ $hasHariLibur ? 'Lengkap' : 'Tidak Ada' }}</span>
                                                </li>
                                            </ul>
                                        </div>

                                        <div
                                            class="mt-3 p-2 rounded {{ $datasetReady ? 'alert alert-success' : 'alert alert-danger' }} mb-0 py-2 px-3 small border-0 d-flex align-items-center shadow-xs">
                                            <i
                                                class="bi {{ $datasetReady ? 'bi-check-circle-fill text-success' : 'bi-exclamation-triangle-fill text-danger' }} me-2 fs-5"></i>
                                            <span class="text-dark">
                                                @if($datasetReady)
                                                    <strong>Dataset siap digunakan</strong> untuk optimasi parameter.
                                                @else
                                                    <strong>Dataset belum lengkap.</strong> Silakan lengkapi data pada menu Master Data
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="card-title text-dark border-0 pb-0 mb-0">
                                        <i class="bi bi-cpu-fill me-2 text-primary-custom"></i>Riwayat Proses SVR Standar (Sebelum
                                        Optimasi)
                                    </h5>
                                    <span class="badge bg-success-subtle text-success border-0 px-2.5 py-1"><i
                                            class="bi bi-check-circle-fill me-1"></i>Selesai Dijalankan</span>
                                </div>

                                <p class="text-secondary small mb-4">Berikut adalah parameter baseline, performa pengujian SVR
                                    Standar (Default) yang telah dilatih sebelumnya, serta langkah-langkah preprocessing data yang
                                    otomatis diselesaikan:</p>
                                ...
                                <div class="row g-4 mb-4">
                                    ...
                                    <div class="col-md-5">
                                        <div class="p-4 bg-light-subtle rounded-3 border border-light h-100">
                                            <h6 class="fw-bold text-dark mb-3"><i
                                                    class="bi bi-gear-wide-connected me-1"></i>Baseline SVR Standar</h6>
                                            <table class="table table-borderless table-sm text-sm mb-0 align-middle">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-secondary text-center">:</td>
                                                        <td><span
                                                                class="badge bg-success-subtle text-success border-0 px-2.5 py-1 fw-bold">{{ $comparisons[0]['mape'] ?? '-' }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td class="text-secondary text-center">:</td>
                                                        <td><span
                                                                class="badge bg-primary-subtle text-primary border-0 px-2.5 py-1 fw-bold">{{ $comparisons[0]['akurasi'] ?? '-' }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                    ...
                                    <div class="col-md-7">
                                        <div class="p-4 bg-light-subtle rounded-3 border border-light h-100">
                                            <h6 class="fw-bold text-dark mb-3"><i class="bi bi-patch-check-fill me-1"></i>Daftar
                                                Tahapan Preprocessing &amp; Prediksi SVR</h6>
                                            <div class="progress-steps-list">
                                                <div class="progress-step success-step" id="grid-pipe-svr-1">
                                                    <span class="step-icon me-2"><i class="bi bi-check-circle-fill text-success"
                        ...
                        <div class="d-flex justify-content-end mb-4">
                            <button class="btn btn-dark px-4 py-2.5 rounded-3 fw-bold text-sm shadow-sm" onclick="goToGridStep(2)">
                                Lanjut ke Konfigurasi Grid Search <i class="bi bi-arrow-right ms-1"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div id="grid-step-content-2" class="step-opt-content d-none">
                        <div class="card mb-4 bg-white">
                            <form id="gridSearchForm" onsubmit="event.preventDefault(); startGridSearchTuning();">
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="card-title border-0 pb-0 mb-0"><i
                                                class="bi bi-gear-fill me-2 text-primary-custom"></i>Konfigurasi Parameter Grid
                                            Search</h5>
                                        <div class="form-check form-switch mb-0">
                                            <input class="form-check-input" type="checkbox" role="switch" id="auto_develop_grid"
                                                onchange="toggleAutoGridDevelop()" @if($gsRun) disabled @endif>
                                            <label class="form-check-label small fw-bold text-secondary"
                                                for="auto_develop_grid">Otomatis Kembangkan</label>
                                        </div>
                                    </div>
                                    @if($gsRun)
                                        @php
                                        ...
                                        @endphp
                                        <div class="alert alert-info border-0 rounded-3 mb-4 p-3 d-flex align-items-center justify-content-between"
                                            id="grid-alert-info">
                                            <div class="d-flex align-items-center">
                                                <i class="bi bi-info-circle-fill fs-4 text-info me-3" id="grid-alert-icon"></i>
                                                <div>
                                                    <h6 class="alert-heading fw-bold mb-1" style="font-size: 13.5px;"
                                                        id="grid-alert-title">Grid Search Telah Dijalankan</h6>
                                                    <p class="mb-0 text-secondary" style="font-size: 12.5px;" id="grid-alert-desc">
                                                        Model aktif saat ini menggunakan parameter optimal: <strong>C =
                                                            {{ $gsC }}</strong>, <strong>&epsilon; = {{ $gsEps }}</strong>,
                                                        <strong>&gamma; = {{ $gsGam }}</strong> dengan nilai <strong>MAPE:
                                                            {{ $gsMape }}%</strong>.
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex gap-2">
                                                <button type="button" class="btn btn-outline-info btn-sm fw-bold px-3 py-1.5 rounded-3"
                                                    onclick="unlockGridParams()" id="btn-unlock-grid">
                                                    <i class="bi bi-pencil-square me-1"></i> Edit Parameter
                                                </button>
                                                <button type="button"
                                                    class="btn btn-outline-secondary btn-sm fw-bold px-3 py-1.5 rounded-3 d-none"
                                                    onclick="lockGridParams()" id="btn-lock-grid">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" name="grid_c" id="grid_c" class="form-control rounded-3"
                                                value="[10, 50, 100, 150, 200]" @if($gsRun) disabled @endif>
                                            <span class="text-muted" style="font-size: 10px;" id="grid_c_help">5 nilai: 10, 50, 100,
                                                150, 200</span>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label small fw-bold text-dark">Rentang Epsilon (&epsilon;)</label>
                                            <input type="text" name="grid_epsilon" id="grid_epsilon" class="form-control rounded-3"
                                                value="[0.001, 0.005, 0.01, 0.05]" @if($gsRun) disabled @endif>
                                            <span class="text-muted" style="font-size: 10px;" id="grid_epsilon_help">4 nilai: 0.001,
                                                0.005, 0.01, 0.05</span>
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label small fw-bold text-dark">Rentang Gamma (&gamma;)</label>
                                            <input type="text" name="grid_gamma" id="grid_gamma" class="form-control rounded-3"
                                                value="['scale', 0.001, 0.01, 0.05]" @if($gsRun) disabled @endif>
                                            <span class="text-muted" style="font-size: 10px;" id="grid_gamma_help">4 nilai: 'scale',
                                                0.001, 0.01, 0.05</span>
                                        </div>
                                    </div>
                                    <div class="alert alert-secondary mt-3 p-3 rounded-3 text-sm d-flex align-items-center">
                                        ...
                                        <div id="grid-info-text">Grid Search akan menguji <strong>80 kombinasi</strong>
                                            (5&times;4&times;4) parameter menggunakan <strong>5-Fold Cross Validation</strong>
                                            (total 400 fits). Metrik evaluasi: <strong>RMSE</strong>.</div>
                                    </div>
                                    <div class="mt-4 d-flex justify-content-between">
                                        <button type="button"
                                            class="btn btn-outline-secondary px-4 py-2.5 rounded-3 fw-bold text-sm"
                                            onclick="goToGridStep(1)">
                        ...
                        <div class="card bg-white mb-4 shadow-sm border border-light">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="card-title mb-0"><i class="bi bi-clock-history me-2 text-primary-custom"></i>Riwayat
                                        Optimasi Grid Search</h5>
                                    @if(!$historyGsRuns->isEmpty())
                                        <button type="button" class="btn btn-outline-danger btn-sm rounded-3 fw-semibold text-xs px-3"
                                            onclick="confirmResetOptimasiAll('grid_search')">
                                        ...
                                        <table class="table table-hover align-middle mb-0" style="font-size: 12.5px;">
                                            ...
                                            <tbody>
                                                @foreach($historyGsRuns as $run)
                                                    ...
                                                    <tr>
                                                        <td class="ps-3">
                                                            {{ \Carbon\Carbon::parse($run->started_at)->timezone('Asia/Jakarta')->translatedFormat('d M Y, H:i') }}
                                                            WIB</td>
                                                        <td>
                                                        ...
                                                        <td class="text-center">
                                                            @if($isActive)
                                                                <span class="badge bg-success text-white rounded-3 px-2 py-1"
                                                                    style="font-size: 11px;">
                                                                    <i class="bi bi-check-circle-fill me-1"></i>Aktif
                                                                </span>
                                                            @else
                                                                <span class="badge bg-secondary text-white rounded-3 px-2 py-1"
                                                                    style="font-size: 11px;">
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-link text-danger p-0 border-0"
                                                                onclick="confirmDeleteOptimasiRun({{ $run->id }}, '{{ \Carbon\Carbon::parse($run->started_at)->timezone('Asia/Jakarta')->translatedFormat('d M Y, H:i') }}', 'Grid Search')"
                                                                title="Hapus Riwayat">
                    ...
                    <div id="grid-step-content-3" class="step-opt-content d-none">
                        <div class="card mb-4 bg-white">
                            <div class="card-body p-4 text-center">
                                <h5 class="card-title text-start mb-4"><i class="bi bi-cpu me-2 text-primary-custom"></i>Proses
                                    Tuning Parameter Grid Search</h5>

                                <div class="py-4">
                                    <!-- Spinner Container -->
                                    <div id="grid-spinner-container">
                                        <div class="spinner-border text-primary mb-3"
                                            style="width: 50px; height: 50px; border-width: 4px;" role="status">
                                            <span class="visually-hidden">Loading...</span>
                                        </div>
                                    </div>
                                    <!-- Success Check Container -->
                                    <div id="grid-success-container" class="d-none">
                                        <div class="d-inline-flex align-items-center justify-content-center bg-success-subtle text-success p-4 rounded-circle mb-3"
                                            style="width: 80px; height: 80px;">
                                            <i class="bi bi-check-lg fs-1"></i>
                                        </div>
                                    </div>
                                    <h6 class="fw-bold text-dark mb-2" id="grid-process-title">Sedang Menyiapkan Grid Search...</h6>
                                    <p class="text-secondary small mx-auto mb-4" style="max-width: 420px;" id="grid-process-desc">
                                        Model SVR standar sedang disiapkan untuk pengujian kombinasi parameter.</p>

                                    <!-- Grid Progress Bar Container -->
                                    <div class="mx-auto mb-4" id="grid-progress-bar-container" style="max-width: 500px;">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="text-secondary small fw-bold" id="grid-iter-label">Kombinasi Grid: 0 /
                                                80</span>
                                            <span class="text-success small fw-bold" id="grid-iter-pct">0%</span>
                                        </div>
                                        <div class="progress" style="height: 10px; border-radius: 6px;">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                                                id="grid-progress-bar" role="progressbar" style="width: 0%;" aria-valuenow="0"
                                ...
                                <!-- Timer Box -->
                                <div class="py-3 bg-light rounded-3 mb-4 mx-auto" id="grid-timer-box"
                                    style="max-width: 400px; border: 1px dashed #cbd5e1;">
                                ...
                                <div class="text-start border-top pt-4 mx-auto" style="max-width: 500px;">
                                    ...
                                    <div class="d-flex flex-column gap-2">
                                        ...
                                        <div class="progress-step" id="grid-pipe-5">
                                            <span class="step-icon me-2 text-muted"><i class="bi bi-circle"></i></span>
                                            <span class="step-label">5. Pembagian Data (Split Data 80:20)</span>
                                        </div>
                                        <div class="progress-step" id="grid-pipe-6">
                                            <span class="step-icon me-2 text-muted"><i class="bi bi-circle"></i></span>
                                            <span class="step-label">6. Pencarian Parameter Optimal (Grid Search)</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card mb-4 bg-white shadow-sm">
                            <div class="card-body">
                                <h5 class="card-title text-dark"><i class="bi bi-diagram-3-fill me-2 text-primary-custom"></i>Detail
                                    Alur Preprocessing & Pipeline Data</h5>
                                @if(!$lastRun)
                                    <div class="text-center py-5">
                                        ...
                                        <p class="text-muted small mb-0 px-4">Detail alur preprocessing dan pipeline data hanya dapat
                                            ditampilkan setelah model SVR berhasil dilatih. Silakan klik tombol <strong>Generate
                                                Prediksi SVR</strong> di atas terlebih dahulu.</p>
                                    </div>
                                @else
                                    <p class="text-secondary small mb-4">Klik setiap tahapan di bawah ini untuk melihat detail data
                                        sebelum/sesudah transformasi, rumusan, dan contoh visualisasi.</p>

                                    <div class="d-flex align-items-start flex-column flex-md-row gap-3">
                                        <!-- Tabs List -->
                                        <div class="nav flex-column nav-pills me-2 col-12 col-md-4 col-lg-3" id="grid-v-pills-tab"
                                            role="tablist" aria-orientation="vertical">
                                            <button class="nav-link active" id="grid-grid-v-pills-cleaning-tab" data-bs-toggle="pill"
                                                data-bs-target="#grid-v-pills-cleaning" type="button" role="tab"
                                                aria-controls="grid-v-pills-cleaning" aria-selected="true">
                                                <span class="tab-step-number">1</span> 1. Pembersihan Data
                                            </button>
                                            <button class="nav-link" id="grid-grid-v-pills-fe-tab" data-bs-toggle="pill"
                                                data-bs-target="#grid-v-pills-fe" type="button" role="tab"
                                                aria-controls="grid-v-pills-fe" aria-selected="false">
                                                <span class="tab-step-number">2</span> 2. Rekayasa Fitur
                                            </button>
                                            <button class="nav-link" id="grid-grid-v-pills-target-tab" data-bs-toggle="pill"
                                                data-bs-target="#grid-v-pills-target" type="button" role="tab"
                                                aria-controls="grid-v-pills-target" aria-selected="false">
                                                <span class="tab-step-number">3</span> 3. Transformasi Data
                                            </button>
                                            <button class="nav-link" id="grid-grid-v-pills-normalisasi-tab" data-bs-toggle="pill"
                                                data-bs-target="#grid-v-pills-normalisasi" type="button" role="tab"
                                                aria-controls="grid-v-pills-normalisasi" aria-selected="false">
                                                <span class="tab-step-number">4</span> 4. Normalisasi Data
                                            </button>
                                            <button class="nav-link" id="grid-grid-v-pills-split-tab" data-bs-toggle="pill"
                                                data-bs-target="#grid-v-pills-split" type="button" role="tab"
                                                aria-controls="grid-v-pills-split" aria-selected="false">
                                                <span class="tab-step-number">5</span> 5. Pembagian Data (Split)
                                            </button>
                                            <button class="nav-link" id="grid-grid-v-pills-training-tab" data-bs-toggle="pill"
                                                data-bs-target="#grid-v-pills-training" type="button" role="tab"
                                                aria-controls="grid-v-pills-training" aria-selected="false">
                                                <span class="tab-step-number">6</span> 6. Pelatihan Model SVR
                                            </button>
                                            <button class="nav-link" id="grid-grid-v-pills-prediction-tab" data-bs-toggle="pill"
                                                data-bs-target="#grid-v-pills-prediction" type="button" role="tab"
                                                aria-controls="grid-v-pills-prediction" aria-selected="false">
                                                <span class="tab-step-number">7</span> 7. Prediksi Pendapatan
                                            </button>
                                        </div>

                                        <!-- Tabs Content -->
                                        <div class="tab-content flex-grow-1 col-12 col-md-8 col-lg-9 border p-4 rounded-3"
                                            id="grid-grid-v-pills-tabContent" style="background-color: #ffffff;">
                                            @php
                                                $rayonRomanMap = [1 => 'I', 2 => 'II', 3 => 'III', 4 => 'IV', 5 => 'V'];
                                            @endphp

                                            <!-- Tab 1: Pembersihan Data -->
                                            <div class="tab-pane fade show active" id="grid-v-pills-cleaning" role="tabpanel"
                                                aria-labelledby="grid-grid-v-pills-cleaning-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 1: Pembersihan Data (Data Cleaning)</h5>
                                                    <span class="badge bg-success-subtle text-success py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">FILTER & IMPUTATION</span>
                                                </div>
                                                <p class="text-secondary text-sm">Sebelum pembersihan, dataset asli (data mentah) dibaca
                                                    dari database. Jika terdapat pencatatan dengan pendapatan bernilai Rp 0, sistem
                                                    mendeteksi dan membersihkan distorsi tersebut dengan aturan bisnis berikut:</p>

                                                <div class="row g-3 mb-4">
                                                    <!-- Drop Rule -->
                                                    <div class="col-md-6">
                                                        <div class="p-3 rounded-3 border border-danger-subtle h-100 bg-white shadow-sm"
                                                            style="border-left: 4px solid #dc2626 !important;">
                                                            <h6 class="fw-bold text-danger mb-2"><i
                                                                    class="bi bi-trash3-fill me-1"></i>1. Penghapusan Baris Pendapatan 0
                                                                pada Hari Kerja Biasa</h6>
                                                            <p class="text-secondary text-xs mb-0">Baris data bernilai <strong>Rp 0 pada
                                                                    hari kerja biasa</strong> (bukan libur nasional) akan
                                                                <strong>dihapus (dropped)</strong> karena diindikasikan sebagai
                                                                kesalahan pencatatan atau juru parkir absen menyetor.</p>
                                                        </div>
                                                    </div>
                                                    <!-- Impute Rule -->
                                                    <div class="col-md-6">
                                                        <div class="p-3 rounded-3 border border-success-subtle h-100 bg-white shadow-sm"
                                                            style="border-left: 4px solid #16a34a !important;">
                                                            <h6 class="fw-bold text-success mb-2"><i class="bi bi-magic me-1"></i>2.
                                                                Imputasi Median pada Hari Libur Nasional</h6>
                                                            <p class="text-secondary text-xs mb-0">Jika pendapatan Rp 0 terjadi pada
                                                                <strong>Hari Libur Nasional</strong>, data tidak dihapus, melainkan
                                                                diisi (imputasi) menggunakan <strong>nilai median pendapatan hari
                                                                    libur</strong> yang bernilai positif.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card border border-light shadow-sm">
                                                        <div class="card-header bg-light py-1.5 px-3">
                                                            <ul class="nav nav-tabs card-header-tabs border-bottom-0"
                                                                id="grid-cleaning-snapshot-tabs" role="tablist">
                                                                <li class="nav-item" role="presentation">
                                                                    <button
                                                                        class="nav-link active fw-bold text-xs py-1.5 px-3 border-0 bg-transparent text-secondary"
                                                                        id="grid-raw-snapshot-tab" data-bs-toggle="tab"
                                                                        data-bs-target="#grid-raw-snapshot-pane" type="button" role="tab"
                                                                        aria-controls="grid-raw-snapshot-pane" aria-selected="true"
                                                                        style="transition: all 0.2s;">
                                                                        <i class="bi bi-file-earmark-spreadsheet me-1"></i>1. Sebelum
                                                                        Pembersihan (Raw Data)
                                                                    </button>
                                                                </li>
                                                                <li class="nav-item" role="presentation">
                                                                    <button
                                                                        class="nav-link fw-bold text-xs py-1.5 px-3 border-0 bg-transparent text-secondary"
                                                                        id="grid-cleaned-snapshot-tab" data-bs-toggle="tab"
                                                                        data-bs-target="#grid-cleaned-snapshot-pane" type="button"
                                                                        role="tab" aria-controls="grid-cleaned-snapshot-pane"
                                                                        aria-selected="false" style="transition: all 0.2s;">
                                                                        <i class="bi bi-shield-check me-1"></i>2. Setelah Pembersihan
                                                                        (Cleaned Data)
                                                                    </button>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="tab-content" id="grid-grid-cleaning-snapshot-tabsContent">
                                                            <!-- Tab 1.1: Sebelum Pembersihan -->
                                                            <div class="tab-pane fade show active" id="grid-raw-snapshot-pane"
                                                                role="tabpanel" aria-labelledby="grid-raw-snapshot-tab">
                                                                <div class="table-responsive">
                                                                    <table
                                                                        class="table table-sm align-middle mb-0 table-hover table-preview-custom">
                                                                        <thead class="table-light">
                                                                        ...
                                                                        <tbody class="text-xs">
                                                                            @foreach($pipelineData['raw_snapshot'] as $snap)
                                                                                ...
                                                                                <tr class="{{ $rowBg }}">
                                                                                    ...
                                                                                    <td><span class="badge bg-light text-dark border">Rayon
                                                                                            {{ $rayonRomanMap[$snap['Rayon']] ?? $snap['Rayon'] }}</span>
                                                                                    </td>
                                                                                    <td class="text-center">
                                                                                        <span
                                                                                            class="badge {{ $isWeekend ? 'bg-danger-subtle text-danger' : 'bg-secondary-subtle text-secondary' }} border-0 py-1 px-2">
                                                                                            {{ $isWeekend ? '1' : '0' }}
                                                                                        </span>
                                                                                    </td>
                                                                                    <td class="text-center">
                                                                                        <span
                                                                                            class="badge {{ $isLibur ? 'bg-danger-subtle text-danger' : 'bg-secondary-subtle text-secondary' }} border-0 py-1 px-2">
                                                                                            {{ $isLibur ? '1' : '0' }}
                                                                                        </span>
                                                                                    </td>
                                                                                    <td
                                                                                        class="text-end fw-semibold {{ $isZero ? 'text-danger' : 'text-dark' }}">
                                                                                        Rp
                                                                                        {{ number_format($snap['Total_Pendapatan'], 0, ',', '.') }}
                                                                                    </td>
                                                                                    <td class="text-end text-secondary">
                                                                                        {{ $snap['Jumlah Jukir'] ?? ($snap['Jumlah_Jukir'] ?? 80) }}
                                                                                        Jukir</td>
                                                            ...
                                                            <div class="tab-pane fade" id="grid-cleaned-snapshot-pane" role="tabpanel"
                                                                aria-labelledby="grid-cleaned-snapshot-tab">
                                                                <div class="table-responsive">
                                                                    <table
                                                                        class="table table-sm align-middle mb-0 table-hover table-preview-custom">
                                                                        <thead class="table-light">
                                                                        ...
                                                                        <tbody class="text-xs">
                                                                            @foreach($pipelineData['cleaned_snapshot'] as $snap)
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <span
                                                                                            class="badge bg-success-subtle text-success border-0 py-1 px-2.5">
                                                ...
                                                @else
                                                    <div class="alert alert-warning py-2 mb-0 mt-3 text-xs border-0">
                                                        <i class="bi bi-info-circle me-1"></i> Detail data snapshot pembersihan tidak
                                                        ditemukan. Silakan jalankan generate ulang model.
                                                    </div>
                                                @endif
                                            </div>

                                            <!-- Tab 2: Rekayasa Fitur -->
                                            <div class="tab-pane fade" id="grid-v-pills-fe" role="tabpanel"
                                                aria-labelledby="grid-grid-v-pills-fe-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 2: Rekayasa Fitur (Feature Engineering)
                                                    </h5>
                                                    <span
                                                        class="badge bg-primary-subtle text-primary-custom py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">FEATURE ENGINEERING</span>
                                                </div>
                                                <p class="text-secondary text-sm">Menambah dimensi fitur masukan agar model SVR mampu
                                                    menangkap pengaruh tren waktu (temporal), efek hari libur, serta karakteristik
                                                    spasial (rayon):</p>

                                                <div class="row g-3 mb-4">
                                                    <div class="col-md-4">
                                                        <div class="card h-100 mb-0 border bg-white p-3 shadow-sm"
                                                            style="border-top: 3px solid #0d6efd !important;">
                                                            <h6 class="fw-bold text-dark text-sm mb-2"><i
                                                                    class="bi bi-calendar3 text-primary-custom me-1"></i>Fitur Temporal
                                                                & Siklikal</h6>
                                                            <p class="text-muted text-xs mb-0">Ekstraksi hari, bulan, tahun, nomor
                                                                minggu, serta transformasi sine & cosine pada hari-dalam-minggu dan
                                                                tanggal-kalender untuk menangkap kontinuitas siklus waktu.</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="card h-100 mb-0 border bg-white p-3 shadow-sm"
                                                            ...
                                                            <h6 class="fw-bold text-dark text-sm mb-2"><i
                                                                    class="bi bi-clock-history text-primary-custom me-1"></i>Fitur Lag &
                                                                Rolling Mean</h6>
                                                            <p class="text-muted text-xs mb-0">Menyisipkan variabel historis
                                                                <code>Lag_1</code>, <code>Lag_7</code>, <code>Lag_14</code>, dan
                                                                <code>Lag_21</code> (pendapatan pada hari-hari sebelumnya) serta rolling
                                                                mean 7 dan 30 hari untuk mendeteksi tren terkini.</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="card h-100 mb-0 border bg-white p-3 shadow-sm"
                                                            style="border-top: 3px solid #212529 !important;">
                                                            <h6 class="fw-bold text-dark text-sm mb-2"><i
                                                                    class="bi bi-geo-alt-fill text-primary-custom me-1"></i>Rayon Dummy
                                                                & Interaksi</h6>
                                                            <p class="text-muted text-xs mb-0">One-hot encoding data Rayon menjadi 5
                                                                kolom dummy terpisah (Rayon_1 s.d Rayon_5) serta perkalian interaksi
                                                                <code>Weekend * Rayon_X</code> untuk melihat perbedaan efek libur di
                                                                tiap rayon.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                @if($pipelineData && isset($pipelineData['fe_snapshot']))
                                                    <div class="card border border-light shadow-sm">
                                                        <div class="card-header bg-light py-2">
                                                            <span class="fw-semibold text-secondary text-xs"><i
                                                                    class="bi bi-table me-1"></i>Hasil Ekstraksi & Rekayasa Fitur (Sample
                                                                Data)</span>
                                                        </div>
                                                        <div class="table-responsive">
                                                            <table
                                                                ...
                                                                <tbody class="text-xs">
                                                                    @foreach($pipelineData['fe_snapshot'] as $snap)
                                                                        <tr>
                                                                            <td><code>{{ $snap['Tanggal'] }}</code></td>
                                                                            <td><span class="badge bg-light text-dark border">Rayon
                                                                                    {{ $rayonRomanMap[$snap['Rayon_asli']] ?? $snap['Rayon_asli'] }}</span>
                                                                            </td>
                                                                            <td class="text-center">{{ $snap['Weekend'] }}</td>
                                                                            <td class="text-center">{{ $snap['Libur_Nasional'] }}</td>
                                                                            <td class="text-center text-secondary">
                                                                                {{ number_format($snap['Hari_Minggu_sin'], 4, ',', '.') }}</td>
                                                                            <td class="text-center text-secondary">
                                                                                {{ number_format($snap['Hari_Minggu_cos'], 4, ',', '.') }}</td>
                                                                            <td class="text-end fw-semibold">Rp
                                                                                {{ number_format($snap['Lag_1'], 0, ',', '.') }}</td>
                                                                            <td class="text-end text-secondary">Rp
                                                                                {{ number_format($snap['Lag_7'], 0, ',', '.') }}</td>
                                                                            <td class="text-end text-success">Rp
                                                                                {{ number_format($snap['Rolling_Mean_7'], 0, ',', '.') }}</td>
                                                                            <td class="text-end text-success text-secondary">Rp
                                                                                {{ number_format($snap['Rolling_Mean_30'], 0, ',', '.') }}</td>
                                                                            <td class="text-center">{{ $snap['Rayon_1'] }}</td>
                                                                            <td class="text-center text-secondary">
                                                                                {{ $snap['Weekend_Rayon_1'] }}</td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                            </table>
                                                ...
                                                @else
                                                    <div class="alert alert-warning py-2 mb-0 text-xs border-0">
                                                        <i class="bi bi-info-circle me-1"></i> Detail data rekayasa fitur tidak ditemukan.
                                                        Silakan jalankan generate ulang model.
                                                    </div>
                                                @endif
                                            </div>

                                            <!-- Tab 3: Transformasi Data -->
                                            <div class="tab-pane fade" id="grid-v-pills-target" role="tabpanel"
                                                aria-labelledby="grid-grid-v-pills-target-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 3: Transformasi Data</h5>
                                                    <span class="badge bg-warning-subtle text-warning py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">DATA TRANSFORMATION</span>
                                                </div>
                                                <p class="text-secondary text-sm">Distribusi data retribusi parkir harian memiliki
                                                    tingkat kemiringan (skewness) tinggi dengan pencilan ekstrem. Dilakukan transformasi
                                                    target untuk menstabilkan variansi model:</p>

                                                <div class="bg-white p-3 rounded-3 border mb-4 shadow-sm"
                                                    style="border-left: 4px solid #ffc107 !important;">
                                                    <h6 class="fw-bold text-dark mb-2 text-sm"><i
                                                            class="bi bi-calculator me-1"></i>Rumus Transformasi Logaritmik:</h6>
                                                    <div class="text-center py-2 bg-light rounded my-2">
                                                        <code class="fs-5 text-dark">y_transformed = ln(y + 1)</code>
                                                    </div>
                                                    <p class="text-secondary text-xs mb-0">Menggunakan fungsi <code>log1p</code> untuk
                                                        menangani nilai nol dengan aman. Setelah prediksi selesai didapatkan dari model
                                                        SVR, nilai dikembalikan ke rupiah asli menggunakan fungsi inverse eksponensial
                                                        <code>expm1</code>: <code>y_original = exp(y_predicted) - 1</code>.</p>
                                                </div>
                                                ...
                                                @if($pipelineData && isset($pipelineData['transformed_snapshot']))
                                                    <div class="card border border-light shadow-sm">
                                                        <div class="card-header bg-light py-2">
                                                            <span class="fw-semibold text-secondary text-xs"><i
                                                                    class="bi bi-table me-1"></i>Hasil Transformasi Target y → ln(y +
                                                                1)</span>
                                                        </div>
                                                        <div class="table-responsive">
                                                            <table
                                                                    ...
                                                                    @foreach($pipelineData['transformed_snapshot'] as $snap)
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-end fw-semibold text-dark">Rp
                                                                                {{ number_format($snap['Total_Pendapatan'], 0, ',', '.') }}</td>
                                                                            <td class="text-end text-primary fw-mono fw-semibold">
                                                                                {{ number_format($snap['Total_Pendapatan_log'], 6, ',', '.') }}
                                                                            </td>
                                                                            <td class="text-center">
                                                                                <span
                                                                                    class="badge bg-primary-subtle text-primary border-0 py-1 px-2"
                                                ...
                                                @else
                                                    <div class="alert alert-warning py-2 mb-0 text-xs border-0">
                                                        <i class="bi bi-info-circle me-1"></i> Detail data transformasi target tidak
                                                        ditemukan. Silakan jalankan generate ulang model.
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="grid-v-pills-normalisasi" role="tabpanel"
                                                aria-labelledby="grid-grid-v-pills-normalisasi-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 4: Normalisasi Data</h5>
                                                    <span class="badge bg-info-subtle text-info py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">SCALING & NORMALIZATION</span>
                                                </div>
                                                <p class="text-secondary text-sm">Menyamakan skala nilai seluruh fitur masukan (X) dan
                                                    target (y) agar fungsi kernel dan batas toleransi kesalahan SVR dapat dikalkulasi
                                                    secara optimal:</p>

                                                <ul class="list-group list-group-flush mb-4 text-sm bg-white p-3 border rounded shadow-sm"
                                                    style="border-left: 4px solid #0dcaf0 !important;">
                                                    <li class="list-group-item bg-transparent px-0 py-2.5">
                                                        <strong>RobustScaler (pada Fitur Masukan X)</strong>: Menskalakan fitur
                                                        menggunakan rentang Median dan Interquartile Range (IQR). Sangat
                                                        direkomendasikan karena kebal terhadap outlier (nilai ekstrem) pendapatan parkir
                                                        pada hari libur besar.
                                                    </li>
                                                    <li class="list-group-item bg-transparent px-0 py-2.5">
                                                        <strong>MinMaxScaler (pada Target y)</strong>: Menskalakan target logaritmik
                                                        pendapatan ke rentang <code>[0, 1]</code> untuk menjaga kestabilan nilai gradien
                                                        bobot penalti SVR.
                                                    </li>
                                                </ul>
                                                ...
                                                @if($pipelineData && isset($pipelineData['normalized_snapshot']))
                                                    <div class="card border border-light shadow-sm">
                                                        <div class="card-header bg-light py-2">
                                                            <span class="fw-semibold text-secondary text-xs"><i
                                                                    class="bi bi-table me-1"></i>Sampel Data Normalisasi X & Target y
                                                                (Robust & MinMaxScaler scaled)</span>
                                                        </div>
                                                        <div class="table-responsive">
                                                            <table
                                                                class="table table-sm align-middle mb-0 table-hover table-preview-custom">
                                                                    ...
                                                                    @foreach($pipelineData['normalized_snapshot'] as $snap)
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-end">Rp
                                                                                {{ number_format($snap['y_original'], 0, ',', '.') }}</td>
                                                                            <td class="text-end text-secondary">
                                                                                {{ number_format($snap['y_log'], 4, ',', '.') }}</td>
                                                                            <td class="text-end fw-bold text-success">
                                                                                {{ number_format($snap['y_scaled'], 6, ',', '.') }}</td>
                                                                            <td class="text-end text-primary">
                                                                                {{ number_format($snap['x_scaled_lag1'], 6, ',', '.') }}</td>
                                                                            <td class="text-end text-primary">
                                                                                {{ number_format($snap['x_scaled_rolling7'], 6, ',', '.') }}
                                                                            </td>
                                                                            <td class="text-end text-primary">
                                                                                {{ number_format($snap['x_scaled_trend'], 6, ',', '.') }}</td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                            </table>
                                                ...
                                                @else
                                                    <div class="alert alert-warning py-2 mb-0 text-xs border-0">
                                                        <i class="bi bi-info-circle me-1"></i> Detail data normalisasi tidak ditemukan.
                                                        Silakan jalankan generate ulang model.
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="grid-v-pills-split" role="tabpanel"
                                                aria-labelledby="grid-grid-v-pills-split-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 5: Pembagian Data (Split Data 80:20)</h5>
                                                    <span class="badge bg-danger-subtle text-danger py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">DATA SPLITTING (80:20)</span>
                                                </div>
                                                <p class="text-secondary text-sm">Dataset dibagi menjadi data training (80%) untuk
                                                    melatih model dan data testing (20%) untuk menguji performa prediksi peramalan.</p>

                                                <div class="p-3 bg-white border rounded-3 mb-4 shadow-sm"
                                                    style="border-left: 4px solid #0d6efd !important;">
                                                    <h6 class="fw-bold text-dark mb-2 text-sm"><i
                                                            class="bi bi-clock-fill me-1 text-primary-custom"></i>Aturan Time-Series
                                                        Split (Kronologis)</h6>
                                                    <p class="text-secondary text-xs mb-0">Pembagian data <strong>WAJIB dilakukan secara
                                                            urut waktu (kronologis)</strong>, bukan secara acak (random train-test
                                                        split). Hal ini krusial untuk mencegah terjadinya kebocoran data (data leakage)
                                                        dari masa depan ke masa lalu, sehingga menjamin validitas hasil pengujian
                                                        peramalan.</p>
                                                </div>

                                                @if($pipelineData && isset($pipelineData['split_snapshot']))
                                                    <h6 class="fw-bold text-secondary text-xs mb-2">Visualisasi Pembagian Dataset (Time
                                                        Series Split):</h6>
                                                    <div class="progress mb-4 border border-light"
                                                        style="height: 35px; border-radius: 8px;">
                                                        <div class="progress-bar bg-primary fw-bold text-xs d-flex flex-column justify-content-center align-items-center shadow-none"
                                                            role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0"
                                                            aria-valuemax="100">
                                                            <span>Data Training (80%)</span>
                                                            <span class="text-white-50"
                                                                style="font-size: 9px;">{{ number_format($pipelineData['split_snapshot']['train_count']) }}
                                                                baris
                                                                ({{ Carbon\Carbon::parse($pipelineData['split_snapshot']['train_start_date'])->translatedFormat('d M Y') }}
                                                                -
                                                                {{ Carbon\Carbon::parse($pipelineData['split_snapshot']['train_end_date'])->translatedFormat('d M Y') }})</span>
                                                        </div>
                                                        <div class="progress-bar bg-warning text-dark fw-bold text-xs d-flex flex-column justify-content-center align-items-center shadow-none"
                                                            role="progressbar" style="width: 20%" aria-valuenow="20" aria-valuemin="0"
                                                            aria-valuemax="100">
                                                            <span>Data Testing (20%)</span>
                                                            <span class="text-muted"
                                                                style="font-size: 9px;">{{ number_format($pipelineData['split_snapshot']['test_count']) }}
                                                                baris
                                                                ({{ Carbon\Carbon::parse($pipelineData['split_snapshot']['test_start_date'])->translatedFormat('d M Y') }}
                                                                -
                                                                {{ Carbon\Carbon::parse($pipelineData['split_snapshot']['test_end_date'])->translatedFormat('d M Y') }})</span>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card h-100 border border-light shadow-sm">
                                                                <div class="card-header bg-primary text-white py-2">
                                                                    <span class="fw-semibold text-xs"><i
                                                                            class="bi bi-clock-history me-1"></i>Batas Akhir Data
                                                                        Training</span>
                                                                </div>
                                                                <div class="card-body p-3">
                                                                    <table
                                                                        class="table table-sm table-borderless mb-0 text-xs text-secondary">
                                                                        <tr>
                                                                            <td>Tanggal Akhir</td>
                                                                            <td>:
                                                                                <strong>{{ Carbon\Carbon::parse($pipelineData['split_snapshot']['train_end_date'])->translatedFormat('d F Y') }}</strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Ukuran Latih</td>
                                                                            <td>:
                                                                                {{ number_format($pipelineData['split_snapshot']['train_count']) }}
                                                                                baris data</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Persentase</td>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="card h-100 border border-light shadow-sm">
                                                                <div class="card-header bg-warning text-dark py-2">
                                                                    <span class="fw-semibold text-xs"><i class="bi bi-clock me-1"></i>Batas
                                                                        Awal Data Testing</span>
                                                                </div>
                                                                <div class="card-body p-3">
                                                                    <table
                                                                        class="table table-sm table-borderless mb-0 text-xs text-secondary">
                                                                        <tr>
                                                                            <td>Tanggal Awal</td>
                                                                            <td>:
                                                                                <strong>{{ Carbon\Carbon::parse($pipelineData['split_snapshot']['test_start_date'])->translatedFormat('d F Y') }}</strong>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Ukuran Uji</td>
                                                                            <td>:
                                                                                {{ number_format($pipelineData['split_snapshot']['test_count']) }}
                                                                                baris data</td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>Persentase</td>
                                                ...
                                                @else
                                                    <div class="alert alert-warning py-2 mb-0 text-xs border-0">
                                                        <i class="bi bi-info-circle me-1"></i> Detail pembagian data tidak ditemukan.
                                                        Silakan jalankan generate ulang model.
                                                    </div>
                                                @endif
                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="grid-v-pills-training" role="tabpanel"
                                                aria-labelledby="grid-grid-v-pills-training-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 6: Pelatihan Model SVR</h5>
                                                    <span class="badge bg-dark text-white py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">SVR MODEL TRAINING</span>
                                                </div>
                                                <p class="text-secondary text-sm">Model di-fitting menggunakan algoritma Support Vector
                                                    Regression (SVR) standar pada data training yang telah dinormalisasi:</p>

                                                <ul
                                                    class="list-group list-group-flush text-sm mb-0 bg-white p-3 border rounded shadow-sm">
                                                    <li class="list-group-item bg-transparent px-0 py-2"><strong>Tipe Kernel</strong>:
                                                        Radial Basis Function (RBF) untuk pola non-linear.</li>
                                                    <li class="list-group-item bg-transparent px-0 py-2"><strong>Regularisasi
                                                            (C)</strong>: <code>{{ $params->c_value ?? '1.0' }}</code></li>
                                                    <li class="list-group-item bg-transparent px-0 py-2"><strong>Epsilon Toleransi
                                                            (&epsilon;)</strong>: <code>{{ $params->epsilon_value ?? '0.1' }}</code>
                                                    </li>
                                                    <li class="list-group-item bg-transparent px-0 py-2"><strong>Gamma
                                                            (&gamma;)</strong>: <code>{{ $params->gamma_value ?? 'scale' }}</code></li>
                                                </ul>
                                            </div>

                                            <!-- Tab 7: Prediksi Pendapatan -->
                                            <div class="tab-pane fade" id="grid-v-pills-prediction" role="tabpanel"
                                                aria-labelledby="grid-grid-v-pills-prediction-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 7: Prediksi Pendapatan</h5>
                                                    <span class="badge bg-dark text-white py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">PREDICTION & DATABASE INSERT</span>
                                                </div>
                                                <p class="text-secondary text-sm">Setelah model SVR selesai dilatih pada data training,
                                                    langkah terakhir adalah memprediksi nilai pendapatan pada data testing (20% data
                                                    terbaru) dan menyimpannya kembali ke database:</p>

                                                <ul
                                                    class="list-group list-group-flush text-sm mb-0 bg-white p-3 border rounded shadow-sm">
                                                    <li class="list-group-item bg-transparent px-0 py-2.5">
                                                        <strong>Inverse Scaling & Transformation</strong>: Hasil keluaran model SVR yang
                                                        masih dalam skala normalisasi `[0, 1]` dan logaritmik ditransformasikan kembali
                                                        ke skala rupiah asli menggunakan fungsi inverse scaling (MinMaxScaler inverse)
                                                        diikuti oleh fungsi eksponensial <code>expm1(y) = e^y - 1</code>.
                                                    </li>
                                                    <li class="list-group-item bg-transparent px-0 py-2.5">
                                                        <strong>Evaluasi Kinerja Model</strong>: Mengkalkulasi metrik evaluasi standar
                                                        seperti MAE, RMSE, MAPE, dan R² score pada data testing untuk mengukur
                                                        keakuratan peramalan model.
                                                    </li>
                                                    <li class="list-group-item bg-transparent px-0 py-2.5">
                                                        <strong>Penyimpanan Database</strong>: Menyimpan seluruh riwayat model running
                                                        parameter, metrik pengujian, dan hasil peramalan per tanggal dan per rayon ke
                                                        dalam database agar dapat ditampilkan secara visual dan diexport.
                                                    </li>
                                                </ul>
                                            </div>
                ...
                <div id="method-content-gwo" class="method-section d-none">
                    ...
                    <div class="card mb-4 bg-white shadow-sm border border-light">
                        <div class="card-body py-3">
                            <div class="stepper-wrapper">
                                <div class="stepper-item active" id="stepper-gwo-1" onclick="goToGwoStep(1)"
                                    style="cursor: pointer;">
                                    <div class="step-number">1</div>
                                    <div class="step-title">Validasi &amp; Riwayat</div>
                                </div>
                    ...
                    <div id="gwo-step-content-2" class="step-opt-content d-none">
                        <div class="card mb-4 bg-white">
                            <form id="gwoSearchForm" onsubmit="event.preventDefault(); startGwoTuning();">
                                <div class="card-body p-4">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h5 class="card-title border-0 pb-0 mb-0"><i
                                                class="bi bi-activity me-2 text-primary-custom"></i>Konfigurasi GWO (Grey Wolf
                                            Optimizer)</h5>
                                    </div>
                                    @if($gwoRun)
                                        @php
                                        ...
                                        <div class="alert alert-info border-0 rounded-3 mb-4 p-3 d-flex align-items-center justify-content-between"
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    <h6 class="alert-heading fw-bold mb-1" style="font-size: 13.5px;"
                                                        id="gwo-alert-title">Grey Wolf Optimizer (GWO) Telah Dijalankan</h6>
                                                    <p class="mb-0 text-secondary" style="font-size: 12.5px;" id="gwo-alert-desc">
                                                        Model aktif saat ini menggunakan parameter optimal: <strong>C =
                                                            {{ $gwoC }}</strong>, <strong>&epsilon; = {{ $gwoEps }}</strong>,
                                                        <strong>&gamma; = {{ $gwoGam }}</strong> dengan nilai <strong>MAPE:
                                                            {{ $gwoMape }}%</strong>.
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex gap-2">
                                                <button type="button" class="btn btn-outline-info btn-sm fw-bold px-3 py-1.5 rounded-3"
                                                    onclick="unlockGwoParams()" id="btn-unlock-gwo">
                                                    <i class="bi bi-pencil-square me-1"></i> Edit Parameter
                                                </button>
                                                <button type="button"
                                                    class="btn btn-outline-secondary btn-sm fw-bold px-3 py-1.5 rounded-3 d-none"
                                                    onclick="lockGwoParams()" id="btn-lock-gwo">
                                                    <i class="bi bi-x-circle me-1"></i> Batal
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3 mb-4">
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" name="wolves" id="gwo_wolves" class="form-control rounded-3"
                                                value="15" min="5" max="50" @if($gwoRun) disabled @endif>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label small fw-bold text-dark">Maksimal Iterasi</label>
                                            <input type="number" name="iterations" id="gwo_iterations"
                                                class="form-control rounded-3" value="30" min="10" max="200" @if($gwoRun) disabled
                                                @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <span class="d-block small fw-bold text-dark mb-0">Search Space Bounds (Rentang
                                                Kontinu)</span>
                                            <div class="form-check form-switch mb-0">
                                                <input class="form-check-input" type="checkbox" role="switch" id="auto_develop_gwo"
                                                    onchange="toggleAutoGwoDevelop()" @if($gwoRun) disabled @endif>
                                                <label class="form-check-label small fw-bold text-secondary"
                                                    for="auto_develop_gwo">Otomatis Kembangkan</label>
                                            </div>
                                        </div>

                                        <div class="row g-3 align-items-center mb-3">
                                            <div class="col-md-4"><label class="small fw-semibold text-secondary">C (Min /
                                                    Max)</label></div>
                                            <div class="col-md-4"><input type="number" step="any" name="c_min" id="c_min"
                                                    class="form-control rounded-3" value="10.0" placeholder="Min" @if($gwoRun)
                                                    disabled @endif></div>
                                            <div class="col-md-4"><input type="number" step="any" name="c_max" id="c_max"
                                                    class="form-control rounded-3" value="300.0" placeholder="Max" @if($gwoRun)
                                                    disabled @endif></div>
                                        </div>
                                        <div class="row g-3 align-items-center mb-3">
                                            <div class="col-md-4"><label class="small fw-semibold text-secondary">Epsilon (Min /
                                                    Max)</label></div>
                                            <div class="col-md-4"><input type="number" step="any" name="epsilon_min"
                                                    id="epsilon_min" class="form-control rounded-3" value="0.0001" placeholder="Min"
                                                    @if($gwoRun) disabled @endif></div>
                                            <div class="col-md-4"><input type="number" step="any" name="epsilon_max"
                                                    id="epsilon_max" class="form-control rounded-3" value="0.05" placeholder="Max"
                                                    @if($gwoRun) disabled @endif></div>
                                        </div>
                                        <div class="row g-3 align-items-center">
                                            <div class="col-md-4"><label class="small fw-semibold text-secondary">Gamma (Min /
                                                    Max)</label></div>
                                            <div class="col-md-4"><input type="number" step="any" name="gamma_min" id="gamma_min"
                                                    class="form-control rounded-3" value="0.0005" placeholder="Min" @if($gwoRun)
                                                    disabled @endif></div>
                                            <div class="col-md-4"><input type="number" step="any" name="gamma_max" id="gamma_max"
                                                    class="form-control rounded-3" value="0.1" placeholder="Max" @if($gwoRun)
                                                    disabled @endif></div>
                                        </div>
                                    </div>
                        ...
                        <div class="card bg-white mb-4 shadow-sm border border-light">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <h5 class="card-title mb-0"><i class="bi bi-clock-history me-2 text-primary-custom"></i>Riwayat
                                        Optimasi Grey Wolf Optimizer (GWO)</h5>
                                    @if(!$historyGwoRuns->isEmpty())
                                        <button type="button" class="btn btn-outline-danger btn-sm rounded-3 fw-semibold text-xs px-3"
                                            onclick="confirmResetOptimasiAll('gwo')">
                                            <i class="bi bi-trash3-fill me-1"></i> Reset Semua Riwayat
                                        </button>
                                    @endif
                                </div>
                                            ...
                                            <tbody>
                                                @foreach($historyGwoRuns as $run)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button" class="btn btn-link text-danger p-0 border-0"
                                                                onclick="confirmDeleteOptimasiRun({{ $run->id }}, '{{ \Carbon\Carbon::parse($run->started_at)->timezone('Asia/Jakarta')->translatedFormat('d M Y, H:i') }}', 'GWO')"
                                                                title="Hapus Riwayat">
                                                                <i class="bi bi-trash fs-5"></i>
                                                            </button>
                                                        </td>
                    ...
                    <div id="gwo-step-content-3" class="step-opt-content d-none">
                        <div class="card mb-4 bg-white">
                            <div class="card-body p-4 text-center">
                                <h5 class="card-title text-start mb-4"><i class="bi bi-activity me-2 text-primary-custom"></i>Proses
                                    Tuning Parameter SVR + GWO</h5>
                                ...
                                <div class="py-4">
                                    ...
                                    <p class="text-secondary small mx-auto mb-4" style="max-width: 420px;" id="gwo-process-desc">
                                        Algoritma Grey Wolf Optimizer sedang diinisialisasi.</p>
                                </div>

                                <!-- Timer Box -->
                                <div class="py-3 bg-light rounded-3 mb-4 mx-auto" id="gwo-timer-box"
                                    style="max-width: 400px; border: 1px dashed #cbd5e1;">
                                    <div class="d-flex justify-content-around text-center">
                                        <div>
                                            <span class="d-block text-muted small fw-semibold">Waktu Berjalan</span>
                                ...
                                <div class="mx-auto mb-4" id="gwo-progress-bar-container" style="max-width: 500px;">
                                    ...
                                    <div class="progress" style="height: 12px; border-radius: 6px;">
                                        <div class="progress-bar progress-bar-striped progress-bar-animated bg-success"
                                            id="gwo-progress-bar" role="progressbar" style="width: 0%;" aria-valuenow="0"
                                            aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>
                                </div>
                        ...
                        <div class="card mb-4 bg-white shadow-sm">
                            <div class="card-body">
                                ...
                                @else
                                    ...
                                    <div class="d-flex align-items-start flex-column flex-md-row gap-3">
                                        <!-- Tabs List -->
                                        <div class="nav flex-column nav-pills me-2 col-12 col-md-4 col-lg-3" id="gwo-v-pills-tab"
                                            role="tablist" aria-orientation="vertical">
                                            <button class="nav-link active" id="gwo-gwo-v-pills-cleaning-tab" data-bs-toggle="pill"
                                                data-bs-target="#gwo-v-pills-cleaning" type="button" role="tab"
                                                aria-controls="gwo-v-pills-cleaning" aria-selected="true">
                                                <span class="tab-step-number">1</span> 1. Pembersihan Data
                                            </button>
                                            <button class="nav-link" id="gwo-gwo-v-pills-fe-tab" data-bs-toggle="pill"
                                                data-bs-target="#gwo-v-pills-fe" type="button" role="tab" aria-controls="gwo-v-pills-fe"
                                                aria-selected="false">
                                                <span class="tab-step-number">2</span> 2. Rekayasa Fitur
                                            </button>
                                            <button class="nav-link" id="gwo-gwo-v-pills-target-tab" data-bs-toggle="pill"
                                                data-bs-target="#gwo-v-pills-target" type="button" role="tab"
                                                aria-controls="gwo-v-pills-target" aria-selected="false">
                                                <span class="tab-step-number">3</span> 3. Transformasi Data
                                            </button>
                                            <button class="nav-link" id="gwo-gwo-v-pills-normalisasi-tab" data-bs-toggle="pill"
                                                data-bs-target="#gwo-v-pills-normalisasi" type="button" role="tab"
                                                aria-controls="gwo-v-pills-normalisasi" aria-selected="false">
                                                <span class="tab-step-number">4</span> 4. Normalisasi Data
                                            </button>
                                            <button class="nav-link" id="gwo-gwo-v-pills-split-tab" data-bs-toggle="pill"
                                                data-bs-target="#gwo-v-pills-split" type="button" role="tab"
                                                aria-controls="gwo-v-pills-split" aria-selected="false">
                                                <span class="tab-step-number">5</span> 5. Pembagian Data (Split)
                                            </button>
                                            <button class="nav-link" id="gwo-gwo-v-pills-training-tab" data-bs-toggle="pill"
                                                data-bs-target="#gwo-v-pills-training" type="button" role="tab"
                                                aria-controls="gwo-v-pills-training" aria-selected="false">
                                                <span class="tab-step-number">6</span> 6. Pelatihan Model SVR
                                            </button>
                                            <button class="nav-link" id="gwo-gwo-v-pills-prediction-tab" data-bs-toggle="pill"
                                                data-bs-target="#gwo-v-pills-prediction" type="button" role="tab"
                                                aria-controls="gwo-v-pills-prediction" aria-selected="false">
                                                <span class="tab-step-number">7</span> 7. Prediksi Pendapatan
                                            </button>
                                        </div>
                                        ...
                                        <!-- Tabs Content -->
                                        <div class="tab-content flex-grow-1 col-12 col-md-8 col-lg-9 border p-4 rounded-3"
                                            id="gwo-gwo-v-pills-tabContent" style="background-color: #ffffff;">
                                            @php
                                                $rayonRomanMap = [1 => 'I', 2 => 'II', 3 => 'III', 4 => 'IV', 5 => 'V'];
                                            @endphp

                                            <!-- Tab 1: Pembersihan Data -->
                                            <div class="tab-pane fade show active" id="gwo-v-pills-cleaning" role="tabpanel"
                                                aria-labelledby="gwo-gwo-v-pills-cleaning-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 1: Pembersihan Data (Data Cleaning)</h5>
                                                    <span class="badge bg-success-subtle text-success py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">FILTER & IMPUTATION</span>
                                                ...
                                                @if($pipelineData && isset($pipelineData['raw_snapshot']) && isset($pipelineData['cleaned_snapshot']))
                                                    <div class="card border border-light shadow-sm">
                                                        <div class="card-header bg-light py-1.5 px-3">
                                                            <ul class="nav nav-tabs card-header-tabs border-bottom-0"
                                                                id="gwo-cleaning-snapshot-tabs" role="tablist">
                                                                <li class="nav-item" role="presentation">
                                                                    <button
                                                                        class="nav-link active fw-bold text-xs py-1.5 px-3 border-0 bg-transparent text-secondary"
                                                                        id="gwo-raw-snapshot-tab" data-bs-toggle="tab"
                                                                        data-bs-target="#gwo-raw-snapshot-pane" type="button" role="tab"
                                                                        aria-controls="gwo-raw-snapshot-pane" aria-selected="true"
                                                                        style="transition: all 0.2s;">
                                                                        <i class="bi bi-file-earmark-spreadsheet me-1"></i>1. Sebelum
                                                                        Pembersihan (Raw Data)
                                                                    </button>
                                                                ...
                                                                <li class="nav-item" role="presentation">
                                                                    <button
                                                                        class="nav-link fw-bold text-xs py-1.5 px-3 border-0 bg-transparent text-secondary"
                                                                        id="gwo-cleaned-snapshot-tab" data-bs-toggle="tab"
                                                                        data-bs-target="#gwo-cleaned-snapshot-pane" type="button" role="tab"
                                                                        aria-controls="gwo-cleaned-snapshot-pane" aria-selected="false"
                                                                        style="transition: all 0.2s;">
                                                                        <i class="bi bi-shield-check me-1"></i>2. Setelah Pembersihan
                                                                        (Cleaned Data)
                                                                    </button>
                                                        ...
                                                        <div class="tab-content" id="gwo-gwo-cleaning-snapshot-tabsContent">
                                                            <!-- Tab 1.1: Sebelum Pembersihan -->
                                                            <div class="tab-pane fade show active" id="gwo-raw-snapshot-pane"
                                                                role="tabpanel" aria-labelledby="gwo-raw-snapshot-tab">
                                                                <div class="table-responsive">
                                                                    <table
                                                                        class="table table-sm align-middle mb-0 table-hover table-preview-custom">
                                                                        <thead class="table-light">
                                                            ...
                                                            <!-- Tab 1.2: Setelah Pembersihan -->
                                                            <div class="tab-pane fade" id="gwo-cleaned-snapshot-pane" role="tabpanel"
                                                                aria-labelledby="gwo-cleaned-snapshot-tab">
                                                                <div class="table-responsive">
                                                                    <table
                                                                        class="table table-sm align-middle mb-0 table-hover table-preview-custom">
                                                                        <thead class="table-light">
                                            ...
                                            <!-- Tab 2: Rekayasa Fitur -->
                                            <div class="tab-pane fade" id="gwo-v-pills-fe" role="tabpanel"
                                                aria-labelledby="gwo-gwo-v-pills-fe-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 2: Rekayasa Fitur (Feature Engineering)
                                                    </h5>
                                                    <span
                                            ...
                                            <!-- Tab 3: Transformasi Data -->
                                            <div class="tab-pane fade" id="gwo-v-pills-target" role="tabpanel"
                                                aria-labelledby="gwo-gwo-v-pills-target-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 3: Transformasi Data</h5>
                                                    <span class="badge bg-warning-subtle text-warning py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">DATA TRANSFORMATION</span>
                                            ...
                                            <!-- Tab 4: Normalisasi Data -->
                                            <div class="tab-pane fade" id="gwo-v-pills-normalisasi" role="tabpanel"
                                                aria-labelledby="gwo-gwo-v-pills-normalisasi-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 4: Normalisasi Data</h5>
                                                    <span class="badge bg-info-subtle text-info py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">SCALING & NORMALIZATION</span>
                                            ...
                                            <!-- Tab 5: Pembagian Data -->
                                            <div class="tab-pane fade" id="gwo-v-pills-split" role="tabpanel"
                                                aria-labelledby="gwo-gwo-v-pills-split-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 5: Pembagian Data (Split Data 80:20)</h5>
                                                    <span class="badge bg-danger-subtle text-danger py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">DATA SPLITTING (80:20)</span>
                                            ...
                                            <!-- Tab 6: Pelatihan Model SVR -->
                                            <div class="tab-pane fade" id="gwo-v-pills-training" role="tabpanel"
                                                aria-labelledby="gwo-gwo-v-pills-training-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 6: Pelatihan Model SVR</h5>
                                                    <span class="badge bg-dark text-white py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">SVR MODEL TRAINING</span>
                                            ...
                                            <!-- Tab 7: Prediksi Pendapatan -->
                                            <div class="tab-pane fade" id="gwo-v-pills-prediction" role="tabpanel"
                                                aria-labelledby="gwo-gwo-v-pills-prediction-tab">
                                                <div class="d-flex justify-content-between align-items-center mb-3">
                                                    <h5 class="fw-bold text-dark mb-0">Langkah 7: Prediksi Pendapatan</h5>
                                                    <span class="badge bg-dark text-white py-1 px-2 text-uppercase fw-bold"
                                                        style="font-size: 10px;">PREDICTION & DATABASE INSERT</span>
                ...
                <div id="results-step-content-5" class="step-opt-content d-none">
                    ...
                    <div class="card mb-4 bg-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <h5 class="card-title border-0 pb-0 mb-0"><i class="bi bi-table me-2 text-primary-custom"></i>Hasil
                                    Optimasi Parameter</h5>
                    ...
                    <div class="card bg-white mb-4">
                        <div class="card-body">
                            <h5 class="card-title"><i class="bi bi-bar-chart-line me-2 text-primary-custom"></i>Grafik Perbandingan
                                Performa Model</h5>
                    ...
                    <div class="card bg-white mb-4">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                <h5 class="card-title mb-0"><i class="bi bi-graph-up me-2 text-primary-custom"></i>Grafik Tren
                                    Perbandingan Hasil Prediksi</h5>
                                <div class="d-flex align-items-center gap-2">
                                    <label for="rayon_id_comp" class="small fw-semibold text-secondary text-nowrap mb-0"
                                        style="font-size: 11.5px;">Filter Rayon:</label>
                                    <select id="rayon_id_comp" class="form-select form-select-sm"
                                        style="font-size: 12px; padding: 4px 12px; height: 32px; width: 160px;"
                                        onchange="window.updateCompChart(this.value)">
                                        <option value="0">Semua Rayon</option>
                                        @foreach($rayons as $rayon)
                                            <option value="{{ $rayon->id }}" {{ $rayonId == $rayon->id ? 'selected' : '' }}>
                    ...
                    <div class="card mb-4 bg-white shadow-sm border border-light">
                        <div class="card-body">
                            <h5 class="card-title text-dark mb-4"><i
                                    class="bi bi-chat-left-text-fill me-2 text-primary-custom"></i>Analisis Perbandingan Performa
                                Model</h5>
                            <x-model-comparison-analysis :comparisons="$comparisons" :chartMetrics="$chartMetrics"
                                :lastRun="$lastRun" :gsRun="$gsRun" :gwoRun="$gwoRun" />
                        </div>
                    </div>
                        ...
                        @if(!$gsRun || !$gsMetricsObj)
                            <div class="card text-center py-5 shadow-sm border border-light bg-white mb-4">
                                <div class="card-body py-4">
                                    ...
                                    <p class="text-muted small mb-0">Belum ada hasil prediksi tersimpan untuk metode Grid Search.
                                        Silakan jalankan <strong>Optimasi Grid Search</strong> terlebih dahulu.</p>
                                </div>
                            </div>
                        @else
                                @php
                                ...
                                <div class="card mb-4 bg-white">
                                    <div class="card-body">
                                        <h6 class="card-title text-warning mb-3"><i class="bi bi-grid-3x3 me-2"></i>Ringkasan Dataset SVR +
                                            Grid Search</h6>
                                        <div class="row g-3 small">
                                            <div class="col-6 col-md-3 border-end border-light">
                                                <span class="text-secondary d-block text-uppercase fw-semibold"
                                                    style="font-size: 9.5px; letter-spacing: 0.5px;">Jumlah Data Efektif</span>
                                                <strong class="fs-6 text-dark">{{ number_format($gsRun->train_rows + $gsRun->test_rows, 0, ',', '.') }}
                                                    baris</strong>
                                                <span class="text-muted d-block" style="font-size: 10px;">(mentah: {{ number_format($gsRun->total_rows, 0, ',', '.') }} baris, terpotong 150 lag)</span>
                                            </div>
                                            <div class="col-6 col-md-3 border-end border-light">
                                                <span class="text-secondary d-block text-uppercase fw-semibold"
                                                    style="font-size: 9.5px; letter-spacing: 0.5px;">Data Training (80%)</span>
                                                <strong class="text-dark d-block mb-1">{{ number_format($gsRun->train_rows, 0, ',', '.') }}
                                                    baris
                                                    @if($gsTrDays) <span class="fw-normal text-secondary"
                                                        style="font-size:11px;">({{ number_format($gsTrDays, 0, ',', '.') }}
                                                    hari)</span>@endif
                                                </strong>
                                            ...
                                            <div class="col-6 col-md-3 border-end border-light">
                                                <span class="text-secondary d-block text-uppercase fw-semibold"
                                                    style="font-size: 9.5px; letter-spacing: 0.5px;">Data Testing (20%)</span>
                                                <strong class="text-dark d-block mb-1">{{ number_format($gsRun->test_rows, 0, ',', '.') }}
                                                    baris
                                                    @if($gsTeDays) <span class="fw-normal text-secondary"
                                                        style="font-size:11px;">({{ number_format($gsTeDays, 0, ',', '.') }}
                                                    hari)</span>@endif
                                                </strong>
                                            ...
                                            <div class="col-6 col-md-3">
                                                <span class="text-secondary d-block text-uppercase fw-semibold"
                                                    style="font-size: 9.5px; letter-spacing: 0.5px;">Waktu Selesai</span>
                                                <strong
                                                    class="text-dark d-block">{{ Carbon\Carbon::parse($gsRun->finished_at)->translatedFormat('d F Y') }}</strong>
                                                <span class="text-muted d-block" style="font-size: 10px;">Jam:
                                                    {{ Carbon\Carbon::parse($gsRun->finished_at)->format('H:i:s') }} WIB</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            ...
                                            <span class="metric-value-custom">Rp
                                                {{ number_format($gsMetricsObj->rmse, 0, ',', '.') }}</span>
                                    ...
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            ...
                                            <span
                                                class="metric-value-custom">{{ number_format($gsMetricsObj->r2_score, 2, ',', '.') }}</span>
                                            @php
                                            ...
                                            @endphp
                                            <div>
                                                <span class="badge border-0 {{ $gsR2Class }} py-1 px-2.5"
                                                    style="font-size: 9.5px; font-weight: 600;">{{ $gsR2Interpret }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            ...
                                            <span
                                                class="metric-value-custom text-secondary">{{ number_format($gsMetricsObj->mape, 2, ',', '.') }}%</span>
                                    ...
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            ...
                                            <span
                                                class="metric-value-custom text-success">{{ number_format($gsMetricsObj->accuracy, 2, ',', '.') }}%</span>
                                            @php
                                            ...
                                            @endphp
                                            <div>
                                                <span class="badge border-0 {{ $gsMapeClass }} py-1 px-2.5"
                                                    style="font-size: 9.5px; font-weight: 600;">{{ $gsMapeInterpret }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 bg-white shadow-sm border border-light">
                                    <div class="card-body">
                                        <h5 class="card-title text-dark mb-3"><i
                                                class="bi bi-chat-left-text-fill me-2 text-primary-custom"></i>Analisis Kinerja &
                                            Rekomendasi Model (Grid Search)</h5>
                                        ...
                                        <x-model-analysis-results :mape="$gsMape" :r2="$gsR2" :rmse="$gsRmse" :meanActual="$gsMeanActual"
                                            target="grid_search" />
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 bg-white">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                            <h5 class="card-title mb-0"><i class="bi bi-graph-up-arrow me-2 text-primary-custom"></i>Grafik
                                                Aktual vs Prediksi Model SVR + Grid Search</h5>
                                            <div class="d-flex align-items-center gap-2">
                                                <label for="rayon_id_gs_chart" class="small fw-semibold text-secondary text-nowrap mb-0"
                                                    style="font-size: 11.5px;">Filter Rayon:</label>
                                                <select id="rayon_id_gs_chart" class="form-select form-select-sm"
                                                    style="font-size: 12px; padding: 4px 12px; height: 32px; width: 160px;"
                                                    onchange="window.updateGsChart(this.value)">
                                                    <option value="0">Semua Rayon</option>
                                                    @foreach($rayons as $rayon)
                                                        <option value="{{ $rayon->id }}" {{ $rayonId == $rayon->id ? 'selected' : '' }}>
                                                            {{ $rayon->nama_rayon }}</option>
                                        ...
                                        <div class="mt-4 p-3 bg-light rounded-3 border-start border-4 border-warning shadow-sm">
                                            <h6 class="fw-bold text-dark mb-2"><i
                                                    class="bi bi-info-circle-fill text-primary-custom me-1"></i>Analisis Grafik (Grid
                                                Search)</h6>
                                            <ul class="mb-0 ps-3 text-secondary small" style="line-height: 1.8;">
                                                <li>
                                                    @if($gsTotalDiffPercent < 5)
                                                        Prediksi sangat sesuai dengan data aktual — selisih kumulatif hanya
                                                        <strong>{{ number_format($gsTotalDiffPercent, 2, ',', '.') }}%</strong>.
                                                    @elseif($gsTotalDiffPercent < 15)
                                                        Prediksi cukup sesuai dengan data aktual — selisih kumulatif
                                                        <strong>{{ number_format($gsTotalDiffPercent, 2, ',', '.') }}%</strong>.
                                                    @else
                                                        Terdapat selisih yang cukup signifikan antara prediksi dan aktual
                                                        (<strong>{{ number_format($gsTotalDiffPercent, 2, ',', '.') }}%</strong>); parameter
                                                        perlu dioptimalkan.
                                                    @endif
                                                </li>
                                                <li>Puncak aktual terjadi pada <strong>{{ $gsMaxActualDate }}</strong> (Rp
                                                    {{ number_format($gsMaxActualVal, 0, ',', '.') }}), prediksi pada hari itu: <strong>Rp
                                                        {{ number_format($gsPredictedAtMaxActual, 0, ',', '.') }}</strong>.</li>
                                                <li>Puncak prediksi jatuh pada <strong>{{ $gsMaxPredictedDate }}</strong> sebesar <strong>Rp
                                                        {{ number_format($gsMaxPredictedVal, 0, ',', '.') }}</strong>.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 bg-white">
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        <div>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <h5 class="card-title mb-0 border-0 pb-0"><i
                                                        class="bi bi-table me-2 text-primary-custom"></i>Tabel Hasil Prediksi Grid Search
                                                    (Data Testing)</h5>

                                                <!-- Rayon Filter Form -->
                                                <form method="GET" action="{{ route('operator.optimasi.index') }}"
                                                    ...
                                                    <label for="rayon_id_gs" class="small fw-semibold text-secondary text-nowrap mb-0"
                                                        style="font-size: 11.5px;">Filter Rayon:</label>
                                                    <select id="rayon_id_gs" name="rayon_id" class="form-select form-select-sm"
                                                        style="font-size: 12px; padding: 4px 12px; height: 32px;"
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover align-middle mb-0 table-custom-nowrap"
                                                    ...
                                                    <tbody>
                                                        @forelse($gsPredictions as $index => $pred)
                                                            <tr>
                                                                ...
                                                                <td><span class="badge bg-light text-dark border">{{ $pred->rayon_name }}</span>
                                                                </td>
                                                                <td class="text-end fw-semibold">Rp
                                                                    {{ number_format($pred->actual_value, 0, ',', '.') }}</td>
                                                                <td class="text-end fw-bold text-primary-custom">Rp
                                                                    {{ number_format($pred->predicted_value, 0, ',', '.') }}</td>
                                                                <td class="text-end text-danger">Rp
                                                                    {{ number_format($pred->error_value, 0, ',', '.') }}</td>
                                                                <td class="text-end fw-semibold">
                                                                    {{ number_format($pred->percentage_error, 2, ',', '.') }}%</td>
                                                            </tr>
                                                        @empty
                                                            <tr>
                                                                <td colspan="7" class="text-center py-4 text-secondary">Tidak ada data prediksi
                                        ...
                                        @if($gsPredictions->hasPages())
                                            <div
                                                class="pagination-container mt-4 d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                                <div class="text-secondary small">
                                                    Menampilkan {{ $gsPredictions->firstItem() ?? 0 }} - {{ $gsPredictions->lastItem() ?? 0 }}
                                                    dari {{ $gsPredictions->total() }} data
                                                </div>
                                                <div>
                                        ...
                                        <div class="mt-4 p-3 bg-light rounded-3 border-start border-4 border-warning shadow-sm">
                                            <h6 class="fw-bold text-dark mb-2"><i
                                                    class="bi bi-grid-3x3-gap-fill text-warning me-1"></i>Kesimpulan Hasil Prediksi Per
                                                Rayon (Grid Search)</h6>
                                            <ul class="mb-0 ps-3 text-secondary small" style="line-height: 1.8;">
                                                @if($gsBestRayon)
                                                    <li>Rayon paling akurat: <strong
                                                            class="text-success">{{ $gsBestRayon->rayon_name }}</strong> dengan MAPE
                                                        <strong>{{ number_format(abs($gsBestRayon->avg_mape), 2, ',', '.') }}%</strong>.</li>
                                                @endif
                                                @if($gsWorstRayon)
                                                    <li>Rayon dengan error terbesar: <strong
                                                            class="text-danger">{{ $gsWorstRayon->rayon_name }}</strong> dengan MAPE
                                                        <strong>{{ number_format(abs($gsWorstRayon->avg_mape), 2, ',', '.') }}%</strong>.</li>
                                                @endif
                                                <li>Rata-rata selisih prediksi harian: <strong>Rp
                                                        {{ number_format(abs($gsAvgDailyDeviation), 0, ',', '.') }}</strong> per hari.</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="d-flex justify-content-between mt-4 mb-4">
                                    <button type="button" class="btn btn-outline-secondary px-4 py-2.5 rounded-3 fw-bold text-sm shadow-sm"
                                        onclick="goToGridStep(2)">
                                        <i class="bi bi-arrow-left me-1"></i> Kembali ke Konfigurasi
                                    </button>
                                    <button type="button" class="btn btn-dark px-4 py-2.5 rounded-3 fw-bold text-sm shadow-sm"
                                        onclick="goToGridStep(5)">
                        ...
                        @if(!$gwoRun || !$gwoMetricsObj)
                            <div class="card text-center py-5 shadow-sm border border-light bg-white mb-4">
                                <div class="card-body py-4">
                                    ...
                                    <p class="text-muted small mb-0">Belum ada hasil prediksi tersimpan untuk metode Grey Wolf
                                        Optimizer. Silakan jalankan <strong>Optimasi GWO</strong> terlebih dahulu.</p>
                                </div>
                            </div>
                        @else
                                @php
                                ...
                                <div class="card mb-4 bg-white">
                                    <div class="card-body">
                                        <h6 class="card-title text-success mb-3"><i class="bi bi-activity me-2"></i>Ringkasan Dataset SVR +
                                            GWO (Grey Wolf)</h6>
                                        <div class="row g-3 small">
                                            <div class="col-6 col-md-3 border-end border-light">
                                                <span class="text-secondary d-block text-uppercase fw-semibold"
                                                    style="font-size: 9.5px; letter-spacing: 0.5px;">Jumlah Data Efektif</span>
                                                <strong class="fs-6 text-dark">{{ number_format($gwoRun->train_rows + $gwoRun->test_rows, 0, ',', '.') }}
                                                    baris</strong>
                                            ...
                                            <div class="col-6 col-md-3 border-end border-light">
                                                <span class="text-secondary d-block text-uppercase fw-semibold"
                                                    style="font-size: 9.5px; letter-spacing: 0.5px;">Data Training (80%)</span>
                                                <strong class="text-dark d-block mb-1">{{ number_format($gwoRun->train_rows, 0, ',', '.') }}
                                                    baris
                                                    @if($gwoTrDays) <span class="fw-normal text-secondary"
                                                        style="font-size:11px;">({{ number_format($gwoTrDays, 0, ',', '.') }}
                                                    hari)</span>@endif
                                                </strong>
                                                <span class="text-muted" style="font-size: 10px;">Periode:
                                                    {{ $gwoRun->train_period }}</span>
                                            </div>
                                            <div class="col-6 col-md-3 border-end border-light">
                                                <span class="text-secondary d-block text-uppercase fw-semibold"
                                                    style="font-size: 9.5px; letter-spacing: 0.5px;">Data Testing (20%)</span>
                                                <strong class="text-dark d-block mb-1">{{ number_format($gwoRun->test_rows, 0, ',', '.') }}
                                                    baris
                                                    @if($gwoTeDays) <span class="fw-normal text-secondary"
                                                        style="font-size:11px;">({{ number_format($gwoTeDays, 0, ',', '.') }}
                                                    hari)</span>@endif
                                                </strong>
                                            ...
                                            <div class="col-6 col-md-3">
                                                <span class="text-secondary d-block text-uppercase fw-semibold"
                                                    style="font-size: 9.5px; letter-spacing: 0.5px;">Waktu Selesai</span>
                                                <strong
                                                    class="text-dark d-block">{{ Carbon\Carbon::parse($gwoRun->finished_at)->translatedFormat('d F Y') }}</strong>
                                                <span class="text-muted d-block" style="font-size: 10px;">Jam:
                                                    {{ Carbon\Carbon::parse($gwoRun->finished_at)->format('H:i:s') }} WIB</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 mb-4">
                                    ...
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            <span class="metric-label-custom">Mean Absolute Error (MAE)</span>
                                            <span class="metric-value-custom">Rp
                                                {{ number_format($gwoMetricsObj->mae, 0, ',', '.') }}</span>
                                            <span class="text-muted small" style="font-size: 11px;">Rata-rata selisih nominal error</span>
                                        </div>
                                    </div>
                                    <!-- RMSE -->
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            <span class="metric-label-custom">Root Mean Squared Error (RMSE)</span>
                                            <span class="metric-value-custom">Rp
                                                {{ number_format($gwoMetricsObj->rmse, 0, ',', '.') }}</span>
                                            <span class="text-muted small" style="font-size: 11px;">Ukuran penyimpangan ekstrem</span>
                                        </div>
                                    </div>
                                    <!-- R2 Score -->
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            <span class="metric-label-custom">R² Score</span>
                                            <span
                                                class="metric-value-custom">{{ number_format($gwoMetricsObj->r2_score, 2, ',', '.') }}</span>
                                            @php
                                            ...
                                            @endphp
                                            <div>
                                                <span class="badge border-0 {{ $gwoR2Class }} py-1 px-2.5"
                                                    style="font-size: 9.5px; font-weight: 600;">{{ $gwoR2Interpret }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- MAPE detail percentage -->
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            <span class="metric-label-custom">Persentase MAPE</span>
                                            <span
                                                class="metric-value-custom text-secondary">{{ number_format($gwoMetricsObj->mape, 2, ',', '.') }}%</span>
                                            <span class="text-muted small" style="font-size: 11px;">Rata-rata persentase error</span>
                                        </div>
                                    </div>
                                    <!-- Akurasi MAPE -->
                                    <div class="col-12 col-md-6 col-lg">
                                        <div class="metric-card-custom">
                                            <span class="metric-label-custom">Akurasi (100% - MAPE)</span>
                                            <span
                                                class="metric-value-custom text-success">{{ number_format($gwoMetricsObj->accuracy, 2, ',', '.') }}%</span>
                                            @php
                                            ...
                                            @endphp
                                            <div>
                                                <span class="badge border-0 {{ $gwoMapeClass }} py-1 px-2.5"
                                                    style="font-size: 9.5px; font-weight: 600;">{{ $gwoMapeInterpret }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 bg-white shadow-sm border border-light">
                                    <div class="card-body">
                                        ...
                                        <x-model-analysis-results :mape="$gwoMape" :r2="$gwoR2" :rmse="$gwoRmse"
                                            :meanActual="$gwoMeanActual" target="gwo" />
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 bg-white">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                                            <h5 class="card-title mb-0"><i class="bi bi-graph-up-arrow me-2 text-primary-custom"></i>Grafik
                                                Aktual vs Prediksi Model SVR + GWO</h5>
                                            <div class="d-flex align-items-center gap-2">
                                                <label for="rayon_id_gwo_chart" class="small fw-semibold text-secondary text-nowrap mb-0"
                                                    style="font-size: 11.5px;">Filter Rayon:</label>
                                                <select id="rayon_id_gwo_chart" class="form-select form-select-sm"
                                                    style="font-size: 12px; padding: 4px 12px; height: 32px; width: 160px;"
                                                    onchange="window.updateGwoChart(this.value)">
                                                    <option value="0">Semua Rayon</option>
                                                    @foreach($rayons as $rayon)
                                                        <option value="{{ $rayon->id }}" {{ $rayonId == $rayon->id ? 'selected' : '' }}>
                                                            {{ $rayon->nama_rayon }}</option>
                                        ...
                                        <div class="mt-4 p-3 bg-light rounded-3 border-start border-4 border-success shadow-sm">
                                            <h6 class="fw-bold text-dark mb-2"><i
                                                    class="bi bi-info-circle-fill text-primary-custom me-1"></i>Analisis Grafik (GWO)</h6>
                                            <ul class="mb-0 ps-3 text-secondary small" style="line-height: 1.8;">
                                                <li>
                                                    @if($gwoTotalDiffPercent < 5)
                                                        Prediksi sangat sesuai dengan data aktual — selisih kumulatif hanya
                                                        <strong>{{ number_format($gwoTotalDiffPercent, 2, ',', '.') }}%</strong>.
                                                    @elseif($gwoTotalDiffPercent < 15)
                                                        Prediksi cukup sesuai dengan data aktual — selisih kumulatif
                                                        <strong>{{ number_format($gwoTotalDiffPercent, 2, ',', '.') }}%</strong>.
                                                    @else
                                                        Terdapat selisih yang cukup signifikan antara prediksi dan aktual
                                                        (<strong>{{ number_format($gwoTotalDiffPercent, 2, ',', '.') }}%</strong>); parameter
                                                        perlu dioptimalkan.
                                                    @endif
                                                </li>
                                                <li>Puncak aktual terjadi pada <strong>{{ $gwoMaxActualDate }}</strong> (Rp
                                                    {{ number_format($gwoMaxActualVal, 0, ',', '.') }}), prediksi pada hari itu: <strong>Rp
                                                        {{ number_format($gwoPredictedAtMaxActual, 0, ',', '.') }}</strong>.</li>
                                                <li>Puncak prediksi jatuh pada <strong>{{ $gwoMaxPredictedDate }}</strong> sebesar
                                                    <strong>Rp {{ number_format($gwoMaxPredictedVal, 0, ',', '.') }}</strong>.</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4 bg-white">
                                    <div class="card-body d-flex flex-column justify-content-between">
                                        <div>
                                            <div class="d-flex justify-content-between align-items-center mb-3">
                                                <h5 class="card-title mb-0 border-0 pb-0"><i
                                                        class="bi bi-table me-2 text-primary-custom"></i>Tabel Hasil Prediksi GWO (Data
                                                    Testing)</h5>
                                                ...
                                                <form method="GET" action="{{ route('operator.optimasi.index') }}"
                                                    ...
                                                    <label for="rayon_id_gwo" class="small fw-semibold text-secondary text-nowrap mb-0"
                                                        style="font-size: 11.5px;">Filter Rayon:</label>
                                                    <select id="rayon_id_gwo" name="rayon_id" class="form-select form-select-sm"
                                                        style="font-size: 12px; padding: 4px 12px; height: 32px;"
                                                        onchange="this.form.submit()">
                                                        <option value="0">Semua Rayon</option>
                                                        @foreach($rayons as $rayon)
                                        ...
                                        @if($gwoPredictions->hasPages())
                                            <div
                                                class="pagination-container mt-4 d-flex justify-content-between align-items-center mt-4 pt-3 border-top">
                                                <div class="text-secondary small">
                                                    Menampilkan {{ $gwoPredictions->firstItem() ?? 0 }} - {{ $gwoPredictions->lastItem() ?? 0 }}
                                                    dari {{ $gwoPredictions->total() }} data
                                                </div>
                                                <div>
                                        ...
                                        <div class="mt-4 p-3 bg-light rounded-3 border-start border-4 border-success shadow-sm">
                                            <h6 class="fw-bold text-dark mb-2"><i
                                                    class="bi bi-grid-3x3-gap-fill text-success me-1"></i>Kesimpulan Hasil Prediksi Per
                                                Rayon (GWO)</h6>
                                            <ul class="mb-0 ps-3 text-secondary small" style="line-height: 1.8;">
                                                @if($gwoBestRayon)
                                                    <li>Rayon paling akurat: <strong
                                                            class="text-success">{{ $gwoBestRayon->rayon_name }}</strong> dengan MAPE
                                                        <strong>{{ number_format(abs($gwoBestRayon->avg_mape), 2, ',', '.') }}%</strong>.</li>
                                                @endif
                                                @if($gwoWorstRayon)
                                                    <li>Rayon dengan error terbesar: <strong
                                                            class="text-danger">{{ $gwoWorstRayon->rayon_name }}</strong> dengan MAPE
                                                        <strong>{{ number_format(abs($gwoWorstRayon->avg_mape), 2, ',', '.') }}%</strong>.</li>
                                                @endif
                                                <li>Rata-rata selisih prediksi harian: <strong>Rp
                                                        {{ number_format(abs($gwoAvgDailyDeviation), 0, ',', '.') }}</strong> per hari.</li>
                                            </ul>
                                        </div>
                                ...
                                <div class="d-flex justify-content-between mt-4 mb-4">
                                    <button type="button" class="btn btn-outline-secondary px-4 py-2.5 rounded-3 fw-bold text-sm shadow-sm"
                                        onclick="goToGwoStep(2)">
                                        <i class="bi bi-arrow-left me-1"></i> Kembali ke Konfigurasi
                                    </button>
                                    <button type="button" class="btn btn-dark px-4 py-2.5 rounded-3 fw-bold text-sm shadow-sm"
                                        onclick="goToGwoStep(5)">
                                        Lanjut ke Perbandingan <i class="bi bi-arrow-right ms-1"></i>
                                    </button>
                                </div>
                            </div>
            ...
            <div class="d-flex justify-content-end gap-2 mb-4">
                ...
                <form id="delete-optimasi-run-form" action="{{ route('operator.optimasi.reset') }}" method="POST"
                    style="display: none;">
                    @csrf
