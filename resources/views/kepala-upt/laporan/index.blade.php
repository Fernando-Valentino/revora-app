    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-lg-4">
            <div class="card border-0 h-100 future-proj-card p-4">
                <div class="card-body p-0 d-flex flex-column h-100" id="future-forecast-card-body" data-rayon-id="{{ $rayonId }}" data-forecast-url="{{ route('kepala-upt.laporan.forecast') }}" data-type="{{ $type ?? 'harian' }}">
                    <div class="d-flex justify-content-between align-items-center mb-4">
