    ...
    <div class="card mb-4 bg-white" style="border-radius: 12px; padding: 20px 24px;">
        <div class="card-body p-0">
            ...
            <div class="mt-4 pt-3 border-top">
                <h6 class="fw-bold text-dark mb-3" style="font-size: 13px;"><i class="bi bi-journal-text me-2 text-primary"></i>Hasil Analisis Tren & Performa Model (Dasar Keputusan Dishub)</h6>
                <div class="row g-3">
