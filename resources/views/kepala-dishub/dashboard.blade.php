...
<div class="container-fluid p-0">
    ...
    <div class="card border-0 text-white mb-4 shadow-sm" style="background: linear-gradient(135deg, #0f172a 0%, #1e1b4b 100%); border-radius: 16px; padding: 24px 28px;">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
            <div>
                ...
                <p class="mb-0 opacity-75 small" style="font-size: 12.5px;">Tinjau performa pendapatan retribusi secara makro, tren pertumbuhan bulanan, dan kebijakan strategis berbasis data prediksi SVR-GWO.</p>
            </div>
            <div>
                <span class="badge bg-warning bg-opacity-15 text-warning px-3 py-2 fw-semibold border border-warning border-opacity-25" style="font-size: 11.5px; border-radius: 8px;">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm bg-white" style="border-radius: 16px; padding: 20px; transition: all 0.2s ease;">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <span class="text-uppercase text-secondary fw-semibold d-block mb-1" style="font-size: 10px; letter-spacing: 0.5px;">Proyeksi Esok</span>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm bg-white" style="border-radius: 16px; padding: 20px; transition: all 0.2s ease;">
                <div class="d-flex align-items-center">
                    <div class="d-flex align-items-center justify-content-center bg-success bg-opacity-10 text-success rounded-3 me-3" style="width: 48px; height: 48px;">
                        <i class="bi bi-wallet2 fs-4"></i>
                    </div>
                    <div>
                        <span class="text-uppercase text-secondary fw-semibold d-block mb-1" style="font-size: 10px; letter-spacing: 0.5px;">Penerimaan YTD ({{ $metrics['latest_year'] }})</span>
                        <h4 class="fw-bold text-dark mb-1" style="font-size: 19px; letter-spacing: -0.5px;">{{ $metrics['ytd_revenue'] }}</h4>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm bg-white" style="border-radius: 16px; padding: 20px; transition: all 0.2s ease;">
                <div class="d-flex align-items-center">
                    ...
                    @endphp
                    <div class="d-flex align-items-center justify-content-center {{ $growthBgClass }} bg-opacity-10 {{ $growthColorClass }} rounded-3 me-3" style="width: 48px; height: 48px;">
                        <i class="bi {{ $growthIcon }} fs-4"></i>
                    </div>
                    <div>
                        <span class="text-uppercase text-secondary fw-semibold d-block mb-1" style="font-size: 10px; letter-spacing: 0.5px;">Tren Bulanan</span>
                        <h4 class="fw-bold mb-1 {{ $growthColorClass }}" style="font-size: 19px; letter-spacing: -0.5px;">{{ $metrics['growth_rate'] }}</h4>
    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm bg-white h-100" style="border-radius: 16px; padding: 24px;">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h5 class="fw-bold text-dark mb-1" style="font-size: 15px;">Grafik Tren Pendapatan & Model SVR</h5>
                        <span class="text-secondary small d-block" style="font-size: 11px;">Perbandingan tren realisasi pendapatan harian vs target prediksi SVR-GWO (10 hari transaksi terakhir)</span>
                    </div>
                </div>
                ...
                <div class="mt-4 pt-3 border-top">
                    <h6 class="fw-bold text-dark mb-3" style="font-size: 13.5px;">
                        <i class="bi bi-bar-chart-steps me-2 text-primary"></i>Analisis Penerimaan Strategis (30 Hari Terakhir)
                    </h6>
                    <div class="row g-3">
                        <div class="col-md-6">
                            <div class="p-3 rounded-3" style="background: #f8fafc; border: 1px solid #e2e8f0;">
                                <span class="text-secondary d-block mb-1" style="font-size: 10px; font-weight: 600;">KONTRIBUSI HARI KERJA (WEEKDAYS)</span>
                                <h5 class="fw-bold text-dark mb-0">{{ $strategicStats['weekday_sum'] }} <span class="text-muted small fs-6">({{ $strategicStats['weekday_percent'] }})</span></h5>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="p-3 rounded-3" style="background: #f8fafc; border: 1px solid #e2e8f0;">
                                <span class="text-secondary d-block mb-1" style="font-size: 10px; font-weight: 600;">KONTRIBUSI AKHIR PEKAN (WEEKEND)</span>
                                <h5 class="fw-bold text-dark mb-0">{{ $strategicStats['weekend_sum'] }} <span class="text-muted small fs-6">({{ $strategicStats['weekend_percent'] }})</span></h5>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        <div class="progress" style="height: 10px; border-radius: 5px;">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ str_replace('%', '', $strategicStats['weekday_percent']) }}%" aria-valuenow="{{ str_replace('%', '', $strategicStats['weekday_percent']) }}" aria-valuemin="0" aria-valuemax="100"></div>
                            <div class="progress-bar bg-warning" role="progressbar" style="width: {{ str_replace('%', '', $strategicStats['weekend_percent']) }}%" aria-valuenow="{{ str_replace('%', '', $strategicStats['weekend_percent']) }}" aria-valuemin="0" aria-valuemax="100"></div>
                        </div>
        ...
        <div class="col-12 col-lg-4">
            <div class="card border-0 shadow-sm bg-white h-100" style="border-radius: 16px; padding: 24px; background: linear-gradient(to bottom, #ffffff, #f8fafc);">
                <div class="mb-3">
                    <h5 class="fw-bold text-dark mb-1" style="font-size: 15px;">Executive Policy Insights</h5>
                    <span class="text-secondary small d-block" style="font-size: 11px;">Rekomendasi strategis Dinas berdasarkan pemodelan data</span>
                </div>
                ...
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="p-3 rounded-3 bg-white border border-light shadow-sm">
                        ...
                        <p class="text-secondary mb-0" style="font-size: 11.5px; line-height: 1.5;">
                            Akurasi model saat ini berada pada tingkat <strong>{{ $metrics['akurasi_model'] }}</strong>. Deviasi nominal harian dinilai sangat andal sebagai dasar perhitungan target PAD tahunan.
                        </p>
                    </div>
                    ...
                    <div class="p-3 rounded-3 bg-white border border-light shadow-sm">
                        ...
                        <p class="text-secondary mb-0" style="font-size: 11.5px; line-height: 1.5;">
                            Rata-rata deviasi penyimpangan adalah <strong>{{ $analysis['avg_deviation'] }}</strong>. Rentang ini merupakan batas wajar/toleransi kebocoran setoran retribusi parkir di lapangan.
                        </p>
                    </div>
                    ...
                    <div class="p-3 rounded-3 bg-white border border-light shadow-sm">
                        ...
                        <p class="text-secondary mb-0" style="font-size: 11.5px; line-height: 1.5;">
                            Pendapatan akhir pekan memberikan kontribusi sebesar <strong>{{ $strategicStats['weekend_percent'] }}</strong>. UPT disarankan menempatkan tim wasdal ekstra untuk mengawal titik parkir akhir pekan.
                        </p>
                    </div>
                </div>
                
                <div class="mt-auto pt-3">
                    <a href="{{ route('kepala-dishub.laporan.index') }}" class="btn btn-primary w-100 rounded-3 py-2 fw-medium" style="font-size: 12.5px;">
    ...
    <div class="card border-0 shadow-sm bg-white" style="border-radius: 16px;">
        <div class="card-body p-4">
            <h5 class="fw-bold text-dark mb-3" style="font-size: 15px;"><i class="bi bi-clock-history me-2 text-secondary"></i>Data Penerimaan Retribusi Terkini</h5>
