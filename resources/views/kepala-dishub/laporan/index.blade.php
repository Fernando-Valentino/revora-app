        ...
        <div class="card-body p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('kepala-dishub.laporan.export-pdf', request()->query()) }}" class="btn btn-pdf btn-sm d-flex align-items-center gap-1.5 px-3 py-1.8" style="font-size: 11.5px;"><i class="bi bi-file-earmark-pdf"></i> Ekspor PDF</a>
                </div>
            </div>
        </div>
    </div>
