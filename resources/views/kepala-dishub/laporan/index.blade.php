...
@section('subtitle', 'Halaman ini digunakan untuk melihat dan mengekspor laporan hasil prediksi sebagai bahan monitoring dan pengambilan keputusan.')

@section('content')
<div class="container-fluid p-0">

    <!-- Info Box: MODE LIHAT & MONITORING -->
    <div class="alert alert-secondary d-flex align-items-center py-2 px-3 mb-4 rounded-3 border-secondary-subtle" role="alert">
        ...
        <div class="small">
            <span class="fw-bold text-dark">MODE LIHAT (MONITORING):</span> Halaman ini menyajikan laporan hasil prediksi. Pengguna hanya dapat memantau realisasi dan hasil proyeksi serta mengekspor dokumen ke dalam format PDF.
        </div>
    </div>
            ...
            <form method="GET" action="" class="row g-3 align-items-end">
                ...
                <div class="col-12 mt-3 d-flex justify-content-between">
                    ...
                    <div class="d-flex gap-2">
                        <!-- Spatie Role rule: Kepala Dishub has only export PDF access -->
                        <a href="{{ route('kepala-dishub.laporan.export-pdf') }}" class="btn btn-outline-danger btn-sm"><i class="bi bi-file-earmark-pdf me-1"></i> Export PDF Laporan</a>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="chart-placeholder" style="height: 280px;">
                ...
                <span class="text-secondary small">Menampilkan visualisasi perbandingan realisasi vs prediksi SVR untuk monitoring pimpinan</span>
            </div>
        </div>
    </div>
