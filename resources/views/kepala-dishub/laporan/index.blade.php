...
@section('subtitle', 'Halaman ini digunakan untuk melihat, memantau, dan mengekspor laporan perbandingan realisasi vs prediksi pendapatan retribusi.')
...
<div class="container-fluid p-0">
    ...
    <!-- Chart & Export Card -->
    <div class="card mb-4 bg-white shadow-sm border border-light" style="border-radius: 12px; padding: 20px 24px;">
        <div class="card-body p-0">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ route('kepala-dishub.laporan.export-pdf', request()->query()) }}" class="btn btn-outline-danger btn-sm" style="font-size: 11.5px;"><i class="bi bi-file-earmark-pdf-fill me-1"></i> Cetak PDF Laporan</a>
                </div>
            </div>
            ...
            @if(count($chartActualValues) > 0)
                ...
                <div class="mt-4 pt-3 border-top">
                    <h6 class="fw-bold text-dark mb-3" style="font-size: 13.5px;"><i class="bi bi-journal-text me-2 text-primary"></i>Hasil Analisis Laporan & Performa Periode Ini (Tinjauan Dishub)</h6>
                    <div class="row g-3">
                        <div class="col-md-4">
