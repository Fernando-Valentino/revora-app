...
@section('subtitle', 'Pantau perbandingan realisasi vs prediksi retribusi parkir serta proyeksi target 7 hari ke depan secara modern.')
            ...
            <div class="card border-0 chart-container-card p-4">
                <div class="card-body p-0">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('kepala-dishub.laporan.export-pdf', request()->query()) }}" class="btn-action-outline btn-sm d-flex align-items-center gap-1.5" style="font-size: 12px; padding: 6px 12px;"><i class="bi bi-file-earmark-pdf text-danger"></i> Cetak PDF</a>
                    </div>
