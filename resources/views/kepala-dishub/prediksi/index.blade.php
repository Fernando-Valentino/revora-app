                        ...
                        <div class="p-3 rounded-3 h-100 {{ $mapeAlertClass }} border border-0">
                            ...
                            <div style="font-size: 12.5px; line-height: 1.6;">
                                @if($mapeVal < 20 && $r2Val >= 0.33)
                                    <p class="mb-3">
                                        <strong>Model Siap Dijadikan Acuan:</strong> Hasil evaluasi menunjukkan model memiliki tingkat kesalahan rendah dan kemampuan pola yang memadai. Sangat layak digunakan oleh Dishub untuk mendukung penyusunan target anggaran retribusi.
                                    </p>
                                    <ul class="list-unstyled d-flex flex-column gap-2 mb-0" style="font-size: 12px;">
                                        <li class="d-flex align-items-start gap-2">
                                            ...
                                            <span>Jadikan proyeksi model ini sebagai acuan resmi penetapan target dan kebijakan anggaran retribusi daerah.</span>
                                        </li>
                                    </ul>
                                @else
                                    <p class="mb-3">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const predTable = $('#predictionTable').DataTable({
                processing: true,
                ajax: {
                    url: '{{ route("kepala-dishub.prediksi.data") }}',
                    data: function (d) {
