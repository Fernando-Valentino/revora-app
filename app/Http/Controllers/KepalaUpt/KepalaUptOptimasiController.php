...
class KepalaUptOptimasiController extends Controller
{
    ...
    public function index()
    {
        ...
        $comparisons = [
            [
                ...
                'c'        => $lastRun ? (is_numeric($lastRun->modelParameter?->c_value)
                    ...
                    : ($lastRun->modelParameter?->c_value ?? '-')) : '-',
                'epsilon'  => $lastRun ? (is_numeric($lastRun->modelParameter?->epsilon_value)
                    ...
                    : ($lastRun->modelParameter?->epsilon_value ?? '-')) : '-',
        ...
        return view('kepala-upt.optimasi.index', compact('grid_best', 'gwo_best', 'comparisons', 'chartMetrics', 'lastRun', 'gsRun', 'gwoRun', 'rayons', 'rayonId'));
    }
}
