...
class KepalaUptLaporanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('kepala-upt.laporan.index', compact('summary', 'reports', 'total_period', 'rayons', 'startDate', 'endDate', 'rayonId', 'chartLabels', 'chartActualValues', 'chartPredictValues', 'analysis'));
    }
